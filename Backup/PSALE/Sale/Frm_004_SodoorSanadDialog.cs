...
{
    public partial class Frm_004_SodoorSanadDialog : Form
    {
        ...
        int _id_faktor;
        public Frm_004_SodoorSanadDialog(int id_faktor)
        {
            _id_faktor = id_faktor;
            InitializeComponent();
        }

        private void Frm_004_SodoorSanadDialog_Load(object sender, EventArgs e)
        {
            editBox3.Text = "فروش - صدور سند فاکتور فروش";
            ...
            dt_kasr = alldatabase.get_list(@"SELECT     dbo.Table_024_Discount.column01 AS name, SUM(dbo.Table_012_Child2_SaleFactor.column04) AS mablagh, dbo.Table_024_Discount.column05, 
...
WHERE     (dbo.Table_012_Child2_SaleFactor.column01 = "  + _id_faktor +  @") AND (dbo.Table_024_Discount.column02 = 'True')
GROUP BY dbo.Table_024_Discount.column01, dbo.Table_024_Discount.column05, dbo.Table_024_Discount.column06, dbo.Table_024_Discount.column07, 
            ...
            dt_ezafe = alldatabase.get_list(@"SELECT     dbo.Table_024_Discount.column01 AS name, SUM(dbo.Table_012_Child2_SaleFactor.column04) AS mablagh, dbo.Table_024_Discount.column05, 
                      dbo.Table_024_Discount.column06, dbo.Table_024_Discount.column07, dbo.Table_024_Discount.column08, dbo.Table_024_Discount.column09, 
                      dbo.Table_024_Discount.column10, dbo.Table_024_Discount.column11, dbo.Table_024_Discount.column12, dbo.Table_024_Discount.column13, 
                      dbo.Table_024_Discount.column14, dbo.Table_024_Discount.column15, dbo.Table_024_Discount.column16, dbo.Table_024_Discount.columnid
FROM         dbo.Table_012_Child2_SaleFactor INNER JOIN
                      dbo.Table_024_Discount ON dbo.Table_012_Child2_SaleFactor.column02 = dbo.Table_024_Discount.columnid
WHERE     (dbo.Table_012_Child2_SaleFactor.column01 = " + _id_faktor + @") AND (dbo.Table_024_Discount.column02 = 'False')
GROUP BY dbo.Table_024_Discount.column01, dbo.Table_024_Discount.column05, dbo.Table_024_Discount.column06, dbo.Table_024_Discount.column07, 
                      dbo.Table_024_Discount.column08, dbo.Table_024_Discount.column09, dbo.Table_024_Discount.column10, dbo.Table_024_Discount.column11, 
                      dbo.Table_024_Discount.column12, dbo.Table_024_Discount.column13, dbo.Table_024_Discount.column14, dbo.Table_024_Discount.column15, 
                      dbo.Table_024_Discount.column16, dbo.Table_024_Discount.columnid");
        dt_faktor_h=alldatabase.get_list("SELECT * FROM Table_010_SaleFactor WHERE columnid=" + _id_faktor);

        dt_faktor_d = alldatabase.get_list(@"SELECT     dbo.Table_010_SaleFactor.column03 AS shakhs, dbo.Table_011_Child1_SaleFactor.column21 AS hazine, dbo.Table_011_Child1_SaleFactor.column22 AS proje, 
                      dbo.Table_010_SaleFactor.columnid AS idfaktor, SUM(dbo.Table_011_Child1_SaleFactor.column20) AS jam
...
GROUP BY dbo.Table_010_SaleFactor.column03, dbo.Table_011_Child1_SaleFactor.column21, dbo.Table_011_Child1_SaleFactor.column22, 
                      dbo.Table_010_SaleFactor.columnid
HAVING      (dbo.Table_010_SaleFactor.columnid = " + _id_faktor  +  ")");
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    price =Int64.Parse(alldatabase.get_one_fiald("SELECT SUM(column20) FROM Table_011_Child1_SaleFactor WHERE column01=" + _id_faktor));
                ...
                alldatabase.close();
                alldatabase.Connect();
                id_person = alldatabase.get_one_fiald("SELECT column03 FROM Table_010_SaleFactor WHERE columnid=" + _id_faktor);
                string sharh = " فاکتور فروش شماره " + alldatabase.get_one_fiald("SELECT column01 FROM Table_010_SaleFactor WHERE columnid=" + _id_faktor);
                db.constr = Properties.Settings.Default.PACNT_ConnectionString;
                alldatabase.close();
                alldatabase.Connect();
            ...
            // sabte bedehkar
                ...
                s = string.Format(s, sanadid.ToString(), multiColumnCombo1.DropDownList.GetValue("ACC_Code").ToString(),
                 ...
                 price.ToString(),"0", "15", _id_faktor, Class_BasicOperation._UserName, "getdate()", Class_BasicOperation._UserName, "getdate()");
                ...
                foreach (DataRow rows in dtdetals.Select())
                {
                    ...
                    "0" ,  rows["mablagh"], "15", _id_faktor, Class_BasicOperation._UserName, "getdate()", Class_BasicOperation._UserName, "getdate()");
                ...
                foreach (DataRow row in dt_ezafe.Select())
                {
                   ...
                   row["mablagh"].ToString(), "0", "15", _id_faktor, Class_BasicOperation._UserName, "getdate()", Class_BasicOperation._UserName, "getdate()");
                ...
                foreach (DataRow row in dt_ezafe.Select())
                {
                   ...
                   row["mablagh"].ToString(), "15", _id_faktor, Class_BasicOperation._UserName, "getdate()", Class_BasicOperation._UserName, "getdate()");
                ...
                foreach (DataRow row in dt_kasr.Select())
                {
                    ...
                    , "15", _id_faktor, Class_BasicOperation._UserName, "getdate()", Class_BasicOperation._UserName, "getdate()");
