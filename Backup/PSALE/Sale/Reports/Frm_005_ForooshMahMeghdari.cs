...
{
    public partial class Frm_005_ForooshMahMeghdari : Form
    {
        db alldatabase = new db();
        public Frm_005_ForooshMahMeghdari()
        {
            InitializeComponent();
        }
        ...
        private void Frm_005_ForooshMahMeghdari_Load(object sender, EventArgs e)
        {
            ...
            alldatabase.Connect();
            view_005_SaleReportByMahTableAdapter.Fill(dataSet_Reports.View_005_SaleReportByMah, Class_BasicOperation._Year);
        ...
        private void gridEX2_DoubleClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.View_005_SaleReportByMahForChartTableAdapter.Fill(this.dataSet_Reports.View_005_SaleReportByMahForChart, Class_BasicOperation._Year, id_kala);
