...
{
    public partial class Frm_001_MoshahadeSefareshat : Form
    {
        ...
        public Frm_001_MoshahadeSefareshat(bool del,bool moshahede,bool virayesh,int id,bool ebtal)
        {
            _ebtal = ebtal;
            _id = id;
            _virayesh = virayesh;
            
            _moshahede = moshahede;
...
WHERE     (dbo.Table_045_PersonInfo.Column12 = 1)";
            ...
            multiColumnCombo1.DataSource = column03TextBox.DataSource;
...
WHERE dbo.table_004_CommodityAndIngredients.column28=1";
            ...
            if (!_moshahede)
                table_005_OrderHeaderBindingSource.Filter = "column29='" + Class_BasicOperation._UserName + "'";
   ...
   // TODO: This line of code loads data into the 'dataSet_Foroosh.Table_005_OrderHeader' table. You can move, or remove it, as needed.
     ...
     if (_virayesh)
     {
         ...
         uiPanel1.SelectPanel(uiPanel3, true);
         table_005_OrderHeaderBindingSource.Filter = "columnid=" + _id.ToString();
...
WHERE     (column02 =
        ...
        private void uiRadioButton2_CheckedChanged(object sender, EventArgs e)
        {
             ...
             numericEditBox1.Show();
            numericEditBox2.Show();
            label12.Show();
            label13.Show();
            label12.Text = "از شماره :";
            label13.Text = "تا شماره :";
            faDatePicker1.Hide();
            faDatePicker2.Hide();
            multiColumnCombo1.Hide();
        ...
        {
            numericEditBox1.Hide();
            numericEditBox2.Hide();
            label12.Hide();
            label13.Hide();
            faDatePicker1.Hide();
            faDatePicker2.Hide();
        ...
        private void uiRadioButton3_CheckedChanged(object sender, EventArgs e)
        {
            ...
            label12.Show();
            label13.Show();
            label12.Text = "از تاریخ :";
            label13.Text = "تا تاریخ :";
            faDatePicker1.Show();
            faDatePicker2.Show();
            multiColumnCombo1.Hide();
        }
        ...
        private void uiRadioButton7_CheckedChanged(object sender, EventArgs e)
        {
            numericEditBox1.Hide();
            numericEditBox2.Hide();
            label12.Hide();
        ...
        private void uiButton1_Click(object sender, EventArgs e)
        {
            if (uiRadioButton1.Checked)
            {
                ...
                table_005_OrderHeaderBindingSource.RemoveFilter();

            }
            else if (uiRadioButton2.Checked)
            {
                if (!_moshahede)
                    table_005_OrderHeaderBindingSource.Filter = "column29='" + Class_BasicOperation._UserName + "' AND " + "column01>=" + numericEditBox1.Value.ToString() + " AND column01<=" + numericEditBox2.Value.ToString();
                else
                    table_005_OrderHeaderBindingSource.Filter = "column01>=" + numericEditBox1.Value.ToString() + " AND column01<=" + numericEditBox2.Value.ToString();
            ...
            else if (uiRadioButton3.Checked)
            {
                ...
                if (!_moshahede)
                    table_005_OrderHeaderBindingSource.Filter = "column29='" + Class_BasicOperation._UserName + "' AND column02 >= '" + faDatePicker1.Text + "' AND column02 <= '" + faDatePicker2.Text+"'";
                else
                    table_005_OrderHeaderBindingSource.Filter = "column02 >= '" + faDatePicker1.Text + "' AND column02 <= '" + faDatePicker2.Text+"'";
            ...
            else if (uiRadioButton4.Checked)
            {
                ...
                if (!_moshahede)
                    table_005_OrderHeaderBindingSource.Filter = "column29='" + Class_BasicOperation._UserName + "' AND " + "column03=" + multiColumnCombo1.Value.ToString();
                else
                    table_005_OrderHeaderBindingSource.Filter = "column03=" + multiColumnCombo1.Value.ToString();
            ...
            else if (uiRadioButton5.Checked)
            {
                ...
                if (!_moshahede)
                    table_005_OrderHeaderBindingSource.Filter = "column29='" + Class_BasicOperation._UserName + "' AND " + "column13=1";
                else
                    table_005_OrderHeaderBindingSource.Filter = "column03=1";
            ...
            else if (uiRadioButton8.Checked)
            {
                ...
                if (!_moshahede)
                    table_005_OrderHeaderBindingSource.Filter = "column29='" + Class_BasicOperation._UserName + "' AND " + "column09=0";
                else
                    table_005_OrderHeaderBindingSource.Filter = "column09=0";
            ...
            else if (uiRadioButton6.Checked)
            {
                ...
                if (!_moshahede)
                    table_005_OrderHeaderBindingSource.Filter = "column29='" + Class_BasicOperation._UserName + "' AND " + "column18=0";
                else
                    table_005_OrderHeaderBindingSource.Filter = "column18=0";
            ...
            else if (uiRadioButton7.Checked)
            {
                ...
                if (!_moshahede)
                    table_005_OrderHeaderBindingSource.Filter = "column29='" + Class_BasicOperation._UserName + "' AND " + "column22=0";
                else
                    table_005_OrderHeaderBindingSource.Filter = "column22=0";


            }

            table_005_OrderHeaderBindingSource_PositionChanged(sender,e);
            column03TextBox_ValueChanged(sender,e);

        }

        private void column02TextBox1_TextChanged(object sender, EventArgs e)
        {
        ...
        {
            if (table_005_OrderHeaderBindingSource.Count < 1)
                return;

            if (uiCheckBox5.CheckState == CheckState.Checked || Convert.ToInt32(columnidTextBox.Text)<0)
                return;
            


            if (uiCheckBox6.CheckState != CheckState.Indeterminate || uiCheckBox7.CheckState != CheckState.Indeterminate || uiCheckBox8.CheckState != CheckState.Indeterminate)
            {
                Class_BasicOperation.ShowMsg("", "کاربر گرامی سفارش بررسی شده است اجازه انصراف را ندارید", "None");
                return;
            }
            ...
            saledatabase.Connect();
            string str;
            str = saledatabase.get_one_fiald("SELECT column09 from Table_005_OrderHeader WHERE columnid=" + columnidTextBox.Text);
            if (str == "True" || str == "False")
            {
                Class_BasicOperation.ShowMsg("", "کاربر گرامی سفارش توسط مدیر فروش بررسی شده است اجازه انصراف را ندارید", "None");
            ...
            if (_ebtal)
            {
                if (gridEX2.RowCount > 0)
                {
                    ...
                    if (DialogResult.Yes == MessageBox.Show(" آیا مایل به انصراف سفارش شماره " + column01TextBox.Text + " هستید؟ ", "", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1, MessageBoxOptions.RightAlign))
                    {

                        string s;
                        s = InputBox.Show("لطفا علت انصراف سفارش مورد نظر را وارد نمایید", "علت انصراف");
                        ...
                        uiCheckBox5.CheckState = CheckState.Checked;
                        editBox14.Text = s;
                        editBox23.Text = Class_BasicOperation._UserName;

                        FarsiLibrary.Utils.PersianDate pd3 = FarsiLibrary.Utils.PersianDateConverter.ToPersianDate(DateTime.Now);
                        editBox22.Text = pd3.ToString("####/##/##").ToString();
                        db.constr = Properties.Settings.Default.PSALE_ConnectionString;
                        saledatabase.close();
                        saledatabase.Connect();
                        column16.Text=saledatabase.get_one_fiald("SELECT getdate()");
            ...
            {
                Class_BasicOperation.ShowMsg("", "کاربر گرامی شما اجازه انصراف سفارش را ندارید", "None");
            }
        }
