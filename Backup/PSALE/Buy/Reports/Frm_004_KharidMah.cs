...
{
    public partial class Frm_004_KharidMahh : Form
    {
        db alldatabase = new db();
        public Frm_004_KharidMahh()
        {
            InitializeComponent();
        }
        ...
        private void Frm_004_KharidMahh_Load(object sender, EventArgs e)
        {
            ...
            this.View_012_BuyReportByMahForChartTableAdapter.Fill(this.DataSet_Reports.View_012_BuyReportByMahForChart,"1390",14);
        ...
        private void gridEX2_DoubleClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.View_012_BuyReportByMahForChartTableAdapter.Fill(this.dataSet_Reports1.View_012_BuyReportByMahForChart, Class_BasicOperation._Year, 150);
