...
namespace PSALE.Buy
{
    public partial class Frm_006_FaktorKharidMarjooi : Form
    {
        bool _del;
        db alldatabase = new db();
        public Frm_006_FaktorKharidMarjooi(bool del)
        {
            _del = del;
            InitializeComponent();
        }
        ...
        {            
            this.table_021_MarjooiBuyTableAdapter.Fill(this.dataSet_Buy.Table_021_MarjooiBuy);

            // TODO: This line of code loads data into the 'dataSet_Buy.Table_023_Child2_MarjooiBuy' table. You can move, or remove it, as needed.
            this.table_023_Child2_MarjooiBuyTableAdapter.Fill(this.dataSet_Buy.Table_023_Child2_MarjooiBuy);
            // TODO: This line of code loads data into the 'dataSet_Buy.Table_022_Child1_MarjooiBuy' table. You can move, or remove it, as needed.
            this.table_022_Child1_MarjooiBuyTableAdapter.Fill(this.dataSet_Buy.Table_022_Child1_MarjooiBuy);
            // TODO: This line of code loads data into the 'dataSet_Buy.Table_021_MarjooiBuy' table. You can move, or remove it, as needed.
            ...
            s = string.Format(s, table_021_MarjooiBuyTableAdapter.Connection.Database.ToString());
...
WHERE     (dbo.Table_045_PersonInfo.Column12 = 1)";
        ...
        private void bindingNavigatorMoveLastItem1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                table_021_MarjooiBuyBindingSource.MoveLast();
        ...
        private void bindingNavigatorMoveNextItem1_Click(object sender, EventArgs e)
        {
            ...
            {
                table_021_MarjooiBuyBindingSource.EndEdit();
                table_021_MarjooiBuyBindingSource.MoveNext();
        ...
        private void bindingNavigatorMovePreviousItem1_Click(object sender, EventArgs e)
        {
            ...
            {
                table_021_MarjooiBuyBindingSource.EndEdit();
                table_021_MarjooiBuyBindingSource.MovePrevious();
        ...
        private void bindingNavigatorMoveFirstItem1_Click(object sender, EventArgs e)
        {
            ...
            {
                table_021_MarjooiBuyBindingSource.EndEdit();
                table_021_MarjooiBuyBindingSource.MoveFirst();
        ...
        private void bt_New_Click(object sender, EventArgs e)
        {
            ...
            {
                table_021_MarjooiBuyBindingSource.EndEdit();
                table_021_MarjooiBuyTableAdapter.Update(dataSet_Buy.Table_021_MarjooiBuy);
                table_021_MarjooiBuyBindingSource.AddNew();
                ...
                column01TextBox.Text = alldatabase.get_one_fiald("SELECT MAX(column01) AS code FROM Table_021_MarjooiBuy");
        ...
        private void bt_Save_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               db.constr=Properties.Settings.Default.PSALE_ConnectionString;
                ...
                table_021_MarjooiBuyBindingSource.EndEdit();
                table_021_MarjooiBuyTableAdapter.Update(dataSet_Buy.Table_021_MarjooiBuy);
                table_022_Child1_MarjooiBuyBindingSource.EndEdit();
                table_022_Child1_MarjooiBuyTableAdapter.Update(dataSet_Buy.Table_022_Child1_MarjooiBuy);
                table_023_Child2_MarjooiBuyBindingSource.EndEdit();
                table_023_Child2_MarjooiBuyTableAdapter.Update(dataSet_Buy.Table_023_Child2_MarjooiBuy);
        ...
        private void bt_Del_Click(object sender, EventArgs e)
        {
            if (_del)
            {
                ...
                {
                    if (DialogResult.Yes == MessageBox.Show("آیا مایل به حذف فاکتور مرجوعی خرید مورد نظر هستید؟", "", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1, MessageBoxOptions.RightAlign))
                    {
                        try
                        {
                            table_022_Child1_MarjooiBuyBindingSource.EndEdit();
                            ...
                            table_021_MarjooiBuyBindingSource_PositionChanged(sender, e);
                            Class_BasicOperation.ShowMsg("", " فاکتور مرجوعی خرید مورد نظر حذف شد", "Information");
                        }
                        catch (Exception ex)
                        {
                            Class_BasicOperation.CheckExceptionType(ex, "");
        ...
        private void gridEX2_Enter(object sender, EventArgs e)
        {
            ...
            {
                table_021_MarjooiBuyBindingSource.CancelEdit();
                Class_BasicOperation.CheckExceptionType(ex, "");
            }
        }
        ...
        private void gridEX1_CurrentCellChanged(object sender, EventArgs e)
        {
            ...
            {
                          numericEditBox3.Value =(dataSet_Buy.Table_023_Child2_MarjooiBuy.Compute("SUM(column04)", "(column05=1) AND (column01="+columnidTextBox.Text+")").ToString());
                          numericEditBox2.Value = (dataSet_Buy.Table_023_Child2_MarjooiBuy.Compute("SUM(column04)", "(column05=0)AND(column01=" + columnidTextBox.Text + ")").ToString());
            }
        ...
        private void gridEX2_DeletingRecord(object sender, Janus.Windows.GridEX.RowActionCancelEventArgs e)
        {
            if (_del)
            {
                if (this.table_022_Child1_MarjooiBuyBindingSource.Count > 0)
                {
        ...
        private void gridEX1_DeletingRecord(object sender, Janus.Windows.GridEX.RowActionCancelEventArgs e)
        {
            if (_del)
            {
                if (this.table_023_Child2_MarjooiBuyBindingSource.Count > 0)
                {
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            if (editBox4.Text != "" && editBox4.Text != "0")
            {
                MessageBox.Show("برای فاکتور مرجوعی خرید مورد نظر حواله صادر شده است");
                return;
            }
            bool advari = false;
            db.constr = Properties.Settings.Default.PERP_ConnectionString;
            ...
            Sale.Frm_008_SodoorSanadMarjooiKharid ob = new Sale.Frm_008_SodoorSanadMarjooiKharid(int.Parse(columnidTextBox.Text));
            ob.ShowDialog();
            if (ob.codesanad != "0")
            {
                db.constr = Properties.Settings.Default.PACNT_ConnectionString;
        ...
        private void toolStripButton3_Click(object sender, EventArgs e)
        {
            if (editBox4.Text == "" || editBox4.Text == "0")
            {
                MessageBox.Show("سندی برای فاکتور مرجوعی خرید مورد نظر ثبت نشده است");
                return;
            }
            ...
            db.constr = Properties.Settings.Default.PACNT_ConnectionString;
            if (table_021_MarjooiBuyBindingSource.Count < 1)
                return;
            if (editBox4.Text != "")
            {
                if (DialogResult.Yes == MessageBox.Show(" آیا سند مربوط به فاکتور مرجوعی خرید شماره " + column01TextBox.Text + " را حذف می کنید؟ ", "", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    try
                    {
                        alldatabase.close();
                        ...
                        alldatabase.delete_update_all("DELETE FROM Table_065_SanadDetail WHERE column17=" + columnidTextBox.Text + " AND column16=20");
                        editBox4.Text ="0";
                 ((DataRowView)table_021_MarjooiBuyBindingSource.CurrencyManager.Current)["column11"]=0;
        ...
        private void toolStripButton5_Click(object sender, EventArgs e)
        {
            ...
            {
            table_021_MarjooiBuyBindingSource.Position=     table_021_MarjooiBuyBindingSource.Find("column01",toolStripTextBox1.TextBox.Text);
        ...
        private void Frm_006_FaktorKharidMarjooi_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void table_022_Child1_MarjooiBuyBindingSource_PositionChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                Sale.Frm_007_HavaleDialogMarjooiKharid ob = new Sale.Frm_007_HavaleDialogMarjooiKharid(Int32.Parse(columnidTextBox.Text));
                ob.ShowDialog();
                if (ob.state == 1)
                {
                    db.constr = Properties.Settings.Default.PWHRS_ConnectionString;
