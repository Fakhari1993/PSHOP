...
{
    public partial class Frm_008_SodoorSanadMarjooiKharid : Form
    {
        ...
        int _id_faktor;
        public Frm_008_SodoorSanadMarjooiKharid(int id_faktor)
        {
            _id_faktor = id_faktor;
            InitializeComponent();
        }

        private void Frm_008_SodoorSanadMarjooiKharid_Load(object sender, EventArgs e)
        {
            editBox3.Text = "فروش - صدور سند فاکتور مرجوعی خرید ";
            ...
            dt_kasr = alldatabase.get_list(@"SELECT     dbo.Table_024_Discount.column01 AS name, SUM(dbo.Table_023_Child2_MarjooiBuy.column04) AS mablagh, dbo.Table_024_Discount.column05, 
...
FROM         dbo.Table_023_Child2_MarjooiBuy INNER JOIN
                      dbo.Table_024_Discount ON dbo.Table_023_Child2_MarjooiBuy.column02 = dbo.Table_024_Discount.columnid
WHERE     (dbo.Table_024_Discount.column02 = 'True') AND (dbo.Table_023_Child2_MarjooiBuy.column01 =" + _id_faktor.ToString() + @")
GROUP BY dbo.Table_024_Discount.column01, dbo.Table_024_Discount.column05, dbo.Table_024_Discount.column06, dbo.Table_024_Discount.column07, 
            ...
            dt_ezafe = alldatabase.get_list(@"SELECT     dbo.Table_024_Discount.column01 AS name, SUM(dbo.Table_023_Child2_MarjooiBuy.column04) AS mablagh, dbo.Table_024_Discount.column05, 
                      dbo.Table_024_Discount.column06, dbo.Table_024_Discount.column07, dbo.Table_024_Discount.column08, dbo.Table_024_Discount.column09, 
                      dbo.Table_024_Discount.column10, dbo.Table_024_Discount.column11, dbo.Table_024_Discount.column12, dbo.Table_024_Discount.column13, 
                      dbo.Table_024_Discount.column14, dbo.Table_024_Discount.column15, dbo.Table_024_Discount.column16, dbo.Table_024_Discount.columnid
FROM         dbo.Table_023_Child2_MarjooiBuy INNER JOIN
                      dbo.Table_024_Discount ON dbo.Table_023_Child2_MarjooiBuy.column02 = dbo.Table_024_Discount.columnid
WHERE     (dbo.Table_024_Discount.column02 = 'False') AND (dbo.Table_023_Child2_MarjooiBuy.column01 =" + _id_faktor.ToString() + @")
GROUP BY dbo.Table_024_Discount.column01, dbo.Table_024_Discount.column05, dbo.Table_024_Discount.column06, dbo.Table_024_Discount.column07, 
                      dbo.Table_024_Discount.column08, dbo.Table_024_Discount.column09, dbo.Table_024_Discount.column10, dbo.Table_024_Discount.column11, 
                      dbo.Table_024_Discount.column12, dbo.Table_024_Discount.column13, dbo.Table_024_Discount.column14, dbo.Table_024_Discount.column15, 
                      dbo.Table_024_Discount.column16, dbo.Table_024_Discount.columnid");
            ...
            dt_faktor_h = alldatabase.get_list("SELECT * FROM Table_021_MarjooiBuy WHERE columnid=" + _id_faktor);

            dt_faktor_d = alldatabase.get_list(@"SELECT     dbo.Table_021_MarjooiBuy.column03 AS shakhs, dbo.Table_022_Child1_MarjooiBuy.column21 AS hazine, dbo.Table_022_Child1_MarjooiBuy.column22 AS proje, 
                      dbo.Table_021_MarjooiBuy.columnid AS idfaktor, SUM(dbo.Table_022_Child1_MarjooiBuy.column20) AS jam
FROM         dbo.Table_022_Child1_MarjooiBuy INNER JOIN
                      dbo.Table_021_MarjooiBuy ON dbo.Table_022_Child1_MarjooiBuy.column01 = dbo.Table_021_MarjooiBuy.columnid
GROUP BY dbo.Table_021_MarjooiBuy.column03, dbo.Table_022_Child1_MarjooiBuy.column21, dbo.Table_022_Child1_MarjooiBuy.column22, 
                      dbo.Table_021_MarjooiBuy.columnid
HAVING      (dbo.Table_021_MarjooiBuy.columnid = " + _id_faktor + ")");
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    price = Int64.Parse(alldatabase.get_one_fiald("SELECT SUM(column20) FROM Table_022_Child1_MarjooiBuy WHERE column01=" + _id_faktor));
                ...
                alldatabase.close();
                alldatabase.Connect();
                id_person = alldatabase.get_one_fiald("SELECT column03 FROM Table_021_MarjooiBuy WHERE columnid=" + _id_faktor);
                string sharh = " فاکتور مرجوعی از خرید شماره " + alldatabase.get_one_fiald("SELECT column01 FROM Table_021_MarjooiBuy WHERE columnid=" + _id_faktor);
                db.constr = Properties.Settings.Default.PACNT_ConnectionString;
                alldatabase.close();
                alldatabase.Connect();
            ...
            // sabte bedehkar
                ...
                s = string.Format(s, sanadid.ToString(), multiColumnCombo1.DropDownList.GetValue("ACC_Code").ToString(),
                 ...
                 price.ToString(),"0", "20", _id_faktor, Class_BasicOperation._UserName, "getdate()", Class_BasicOperation._UserName, "getdate()");
                ...
                foreach (DataRow rows in dtdetals.Select())
                {
                    ...
                    "0" ,  rows["mablagh"], "20", _id_faktor, Class_BasicOperation._UserName, "getdate()", Class_BasicOperation._UserName, "getdate()");
                ...
                foreach (DataRow row in dt_ezafe.Select())
                {
                   ...
                   row["mablagh"].ToString(), "0", "20", _id_faktor, Class_BasicOperation._UserName, "getdate()", Class_BasicOperation._UserName, "getdate()");
                ...
                foreach (DataRow row in dt_ezafe.Select())
                {
                    ...
                    s = string.Format(s,sanadid , row["column16"].ToString(),
                     ...
                     moincode, tafsilicode, jozcode, "NULL", idhazine, idproje, row["name"].ToString(), "0",
                   row["mablagh"].ToString(), "20", _id_faktor, Class_BasicOperation._UserName, "getdate()", Class_BasicOperation._UserName, "getdate()");
                ...
                foreach (DataRow row in dt_kasr.Select())
                {
                    ...
                    s = string.Format(s, sanadid, row["column10"].ToString(),
                     row["column05"].ToString(), row["column06"].ToString(),
                     moincode, tafsilicode, jozcode, "NULL", idhazine, idproje, row["name"].ToString(),row["mablagh"].ToString(),"0" 
                    , "20", _id_faktor, Class_BasicOperation._UserName, "getdate()", Class_BasicOperation._UserName, "getdate()");
                ...
                foreach (DataRow row in dt_kasr.Select())
                {
                    ...
                    s = string.Format(s, sanadid, row["column16"].ToString(),
                     row["column11"].ToString(), row["column12"].ToString(),
                     moincode, tafsilicode, jozcode, id_person, idhazine, idproje, row["name"].ToString(), "0", row["mablagh"].ToString()
                    , "20", _id_faktor, Class_BasicOperation._UserName, "getdate()", Class_BasicOperation._UserName, "getdate()");
