...
{
    public partial class Frm_016_ViewReturnSaleFactors : Form
    {
        ...
        bool Isadmin = false;
        Int16 projectId;
        public Frm_016_ViewReturnSaleFactors()
        {
            InitializeComponent();
        }
        ...
        private void Form_008_ViewSaleFactors_Load(object sender, EventArgs e)
        {
            ...
            gridEX_Header.DropDowns["Seller"].SetDataBinding(clDoc.ReturnTable(ConBase.ConnectionString, "Select ColumnId as Columnid,Column01,Column02 from Table_045_PersonInfo"), "");
            ...
            //*******************************************
            HeaderAdapter = new SqlDataAdapter("Select * from Table_018_MarjooiSale where Column02>='" +
                faDatePickerStrip1.FADatePicker.Text + "' and Column02<='" + faDatePickerStrip2.FADatePicker.Text + "' and (Column30=" + projectId + " or '" + (Isadmin) + "'=N'True')", ConSale);
            ...
            dbo.Table_019_Child1_MarjooiSale ON dbo.Table_018_MarjooiSale.columnid = dbo.Table_019_Child1_MarjooiSale.column01 WHERE     (dbo.Table_018_MarjooiSale.column02 >='" + faDatePickerStrip1.FADatePicker.Text
              + "' and dbo.Table_018_MarjooiSale.column02<='" + faDatePickerStrip2.FADatePicker.Text + "') and (dbo.Table_018_MarjooiSale.Column30=" + projectId + " or '" + (Isadmin) + "'=N'True')", ConSale);
            ...
            dbo.Table_020_Child2_MarjooiSale ON dbo.Table_018_MarjooiSale.columnid = dbo.Table_020_Child2_MarjooiSale.column01 WHERE     (dbo.Table_018_MarjooiSale.column02 >='"
                + faDatePickerStrip1.FADatePicker.Text + "' and dbo.Table_018_MarjooiSale.column02<='" + faDatePickerStrip2.FADatePicker.Text + "') and (dbo.Table_018_MarjooiSale.Column30=" + projectId + " or '" + (Isadmin) + "'=N'True')", ConSale);
        ...
        private void bt_Search_Click(object sender, EventArgs e)
        {
            if (faDatePickerStrip1.FADatePicker.SelectedDateTime.HasValue && faDatePickerStrip2.FADatePicker.SelectedDateTime.HasValue && faDatePickerStrip2.FADatePicker.Text.Length == 10 && faDatePickerStrip1.FADatePicker.Text.Length == 10)
            {
                ...
                Child1Adapter = new SqlDataAdapter(@"SELECT     dbo.Table_019_Child1_MarjooiSale.*    FROM         dbo.Table_018_MarjooiSale INNER JOIN
                 dbo.Table_019_Child1_MarjooiSale ON dbo.Table_018_MarjooiSale.columnid = dbo.Table_019_Child1_MarjooiSale.column01 WHERE     (dbo.Table_018_MarjooiSale.column02 >='"
                    + faDatePickerStrip1.FADatePicker.Text + "' and dbo.Table_018_MarjooiSale.column02<='" + faDatePickerStrip2.FADatePicker.Text + "' and (dbo.Table_018_MarjooiSale.Column30=" + projectId + " or '" + (Isadmin) + "'=N'True'))", ConSale);
                Child1Adapter.Fill(dataSet1, "Child1");
        ...
        private void Form_008_ViewSaleFactors_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                ...
                if (faDatePickerStrip1.FADatePicker.SelectedDateTime.HasValue && faDatePickerStrip2.FADatePicker.SelectedDateTime.HasValue)
                    Properties.Settings.Default.ViewReturnSale = faDatePickerStrip1.FADatePicker.Text + "-" + faDatePickerStrip2.FADatePicker.Text;
