...
{
    public partial class Frm_037_ReturnAmaniFaktor : Form
    {
        bool _del;
        ...
        public Frm_037_ReturnAmaniFaktor(bool del)
        {
            _del = del;
            InitializeComponent();
        }

        public Frm_037_ReturnAmaniFaktor(bool del, int ID)
        {
            _del = del;
            _ID = ID;
            InitializeComponent();
...
WHERE     (dbo.Table_045_PersonInfo.Column12 = 1)");
            ...
            if (_ID != 0)
            {
                this.table_080_ReturnAmaniTableAdapter.FillByID(this.dataSet_Sale5.Table_080_ReturnAmani, _ID);
                this.table_085_ReturnAmaniChildTableAdapter.FillBy_HeaderID(this.dataSet_Sale5.Table_085_ReturnAmaniChild, _ID);
        ...
        private void bt_New_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //gridEX1.SetValue("Column01", clDoc.MaxNumber(ConSale.ConnectionString, "Table_080_ReturnAmani", "Column01").ToString());
                ...
                ((DataRowView)table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["Column28"] = 0;
        ...
        {
            if (this.table_080_ReturnAmaniBindingSource.Count > 0 &&
               gridEX_List.AllowEdit == InheritableBoolean.True &&
               gridEX1.GetRow().Cells["Column03"].Text.Trim() != "")
            {
                ...
                DataRowView Row = (DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current;
                ...
                {
                    gridEX1.SetValue("Column01", clDoc.MaxNumber(ConSale.ConnectionString, "Table_080_ReturnAmani", "Column01").ToString());
                    this.table_080_ReturnAmaniBindingSource.EndEdit();
                }
                ...
                this.table_080_ReturnAmaniBindingSource.EndEdit();
                this.table_085_ReturnAmaniChildBindingSource.EndEdit();

                this.table_080_ReturnAmaniTableAdapter.Update(dataSet_Sale5.Table_080_ReturnAmani);
                this.table_085_ReturnAmaniChildTableAdapter.Update(dataSet_Sale5.Table_085_ReturnAmaniChild);
        ...
        public void bt_Del_Click(object sender, EventArgs e)
        {
            if (this.table_080_ReturnAmaniBindingSource.Count > 0)
            {
                try
                {
                    ...
                    string RowID = ((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["ColumnId"].ToString();

                    //if (clDoc.OperationalColumnValue("Table_080_ReturnAmani", "Column20", RowID) != 0)
                    //{
                    //    dataSet_Sale5.EnforceConstraints = false;
                    //    this.table_080_ReturnAmaniTableAdapter.FillByID(this.dataSet_Sale5.Table_080_ReturnAmani, _ID);
                    //    this.table_085_ReturnAmaniChildTableAdapter.FillBy_HeaderID(this.dataSet_Sale5.Table_085_ReturnAmaniChild, _ID);
                    ...
                    //int DocId = clDoc.OperationalColumnValue("Table_080_ReturnAmani", "Column10", RowID);
                    //int DraftId = clDoc.OperationalColumnValue("Table_080_ReturnAmani", "Column09", RowID);
                    //int PrefactorId = clDoc.OperationalColumnValue("Table_080_ReturnAmani", "Column07", RowID);
                    ...
                    if (DialogResult.Yes == MessageBox.Show("در صورت حذف فاکتور، سند حسابداری مربوط نیز حذف خواهند شد" + Environment.NewLine + "آیا مایل به حذف فاکتور هستید؟", "", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                    {
                        ...
                        {
                            //حذف فاکتور
                            foreach (DataRowView item in this.table_085_ReturnAmaniChildBindingSource)
                            {
                                item.Delete();
                            }
                            ...
                            this.table_080_ReturnAmaniBindingSource.EndEdit();
                            this.table_085_ReturnAmaniChildBindingSource.EndEdit();
                            this.table_080_ReturnAmaniBindingSource.RemoveCurrent();
                            this.table_080_ReturnAmaniTableAdapter.Update(dataSet_Sale5.Table_080_ReturnAmani);
                            this.table_085_ReturnAmaniChildTableAdapter.Update(dataSet_Sale5.Table_085_ReturnAmaniChild);
        ...
        private void gridEX_List_Enter(object sender, EventArgs e)
        {
            try
            {
                ...
                table_080_ReturnAmaniBindingSource.EndEdit();
            }
            catch (Exception ex)
            {
                gridEX1.Focus();
                ...
                if (this.table_080_ReturnAmaniBindingSource.Count > 0)
                {
                    if (UserScope.CheckScope(Class_BasicOperation._UserName, "Column11", 128))
                    {
                        _05_Sale.Reports.ReportForm frm = new Reports.ReportForm(
                                int.Parse(((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["Column01"].ToString()), false, " فاکتور مرجوعی امانی ", 2, Convert.ToDouble(txt_TotalPrice.Value));
                        frm.ShowDialog();
                    }
        ...
        public void bt_Search_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(txt_Search.Text.Trim()))
            {
                try
                {
                    ...
                    //if (dataSet_Sale5.Table_080_ReturnAmani.GetChanges() != null || dataSet_Sale5.Table_085_ReturnAmaniChild.GetChanges() != null || dataSet_Sale5.Table_012_Child2_SaleFactor.GetChanges() != null)
                    //{
                    ...
                    this.table_080_ReturnAmaniTableAdapter.FillByID(this.dataSet_Sale5.Table_080_ReturnAmani, RowID);
                    this.table_085_ReturnAmaniChildTableAdapter.FillBy_HeaderID(this.dataSet_Sale5.Table_085_ReturnAmaniChild, RowID);
        ...
        private int ReturnIDNumber(int FactorNum)
        {
            using (SqlConnection con = new SqlConnection(Properties.Settings.Default.SALE))
            {
                con.Open();
                int ID = 0;
                SqlCommand Commnad = new SqlCommand("Select ISNULL(columnid,0) from Table_080_ReturnAmani where column01=" + FactorNum, con);
                try
                {
        ...
        private void bt_ViewFactors_Click(object sender, EventArgs e)
        {
            if (UserScope.CheckScope(Class_BasicOperation._UserName, "Column11", 67))
            {
                ...
                {
                    if (item.Name == "Frm_038_ViewReturnAmaniFactors")
                    {
                        item.BringToFront();
                        return;
                    }
                }
                _05_Sale.Frm_038_ViewReturnAmaniFactors frm = new Frm_038_ViewReturnAmaniFactors();
                try
                {
        ...
        private void gridEX_List_EditingCell(object sender, EditingCellEventArgs e)
        {
            //try
            //{
            //    if (((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)[
            //        "Column09"].ToString() != "0" &&
            //        ((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)[
            //        "Column10"].ToString() == "0")
            //    {
        ...
        private void mnu_ViewReturnFactor_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (UserScope.CheckScope(Class_BasicOperation._UserName, "Column10", 20))
                {
                    ...
                    frm.ShowDialog();
                    int SaleId = int.Parse(((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["ColumnId"].ToString());
                    dataSet_Sale5.EnforceConstraints = false;
                    this.table_080_ReturnAmaniTableAdapter.FillByID(this.dataSet_Sale5.Table_080_ReturnAmani, SaleId);
                    this.table_085_ReturnAmaniChildTableAdapter.FillBy_HeaderID(this.dataSet_Sale5.Table_085_ReturnAmaniChild, SaleId);
                    dataSet_Sale5.EnforceConstraints = true;
                    table_070_AmaniFactorBindingSource_PositionChanged(sender, e);
        ...
        private Decimal LastBuyGoodPrice(int GoodCode)
        {
            ...
            insert into @t SELECT     Table_016_Child1_BuyFactor.column02,  MAX(Table_080_ReturnAmani.column02) AS Date,1
            FROM         Table_016_Child1_BuyFactor INNER JOIN
            Table_080_ReturnAmani ON Table_016_Child1_BuyFactor.column01 = Table_080_ReturnAmani.columnid
            ...
            dbo.Table_080_ReturnAmani.column02 AS Date
            FROM         dbo.Table_016_Child1_BuyFactor INNER JOIN
            dbo.Table_080_ReturnAmani ON dbo.Table_016_Child1_BuyFactor.column01 = dbo.Table_080_ReturnAmani.columnid
            where Table_016_Child1_BuyFactor.column02=" + GoodCode + @"
            GROUP BY dbo.Table_016_Child1_BuyFactor.column02, dbo.Table_016_Child1_BuyFactor.column10, dbo.Table_080_ReturnAmani.column02;
            update @t set Price=gheymat2 from @t2 as main_table where GoodCode=codekala2 and Date=date2; 
            select * from @t");
        ...
        private void bindingNavigatorMoveFirstItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dataSet_Sale5.Table_080_ReturnAmani.GetChanges() != null || dataSet_Sale5.Table_085_ReturnAmaniChild.GetChanges() != null
                )
                {
                    if (DialogResult.Yes == MessageBox.Show("آیا مایل به ذخیره تغییرات هستید؟", "", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1, MessageBoxOptions.RightAlign))
                    {
                ...
                DataTable Table = clDoc.ReturnTable(ConSale.ConnectionString, "Select ISNULL((Select min(Column01) from Table_080_ReturnAmani),0) as Row");
                if (Table.Rows[0]["Row"].ToString() != "0")
                {
                    DataTable RowId = clDoc.ReturnTable(ConSale.ConnectionString, "Select ColumnId from Table_080_ReturnAmani where Column01=" + Table.Rows[0]["Row"].ToString());
                    dataSet_Sale5.EnforceConstraints = false;
                    this.table_080_ReturnAmaniTableAdapter.FillByID(this.dataSet_Sale5.Table_080_ReturnAmani, int.Parse(RowId.Rows[0]["ColumnId"].ToString()));

                    this.table_085_ReturnAmaniChildTableAdapter.FillBy_HeaderID(this.dataSet_Sale5.Table_085_ReturnAmaniChild, int.Parse(RowId.Rows[0]["ColumnId"].ToString()));
                    dataSet_Sale5.EnforceConstraints = true;
                    this.table_070_AmaniFactorBindingSource_PositionChanged(sender, e);
                }
            ...
            if (this.table_080_ReturnAmaniBindingSource.Count > 0)
            {
                try
                {
                    ...
                    DataTable Table = clDoc.ReturnTable(ConSale.ConnectionString,
                        "Select ISNULL((Select max(Column01) from Table_080_ReturnAmani where Column01<" +
                        ((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["Column01"].ToString() + "),0) as Row");
                    if (Table.Rows[0]["Row"].ToString() != "0")
                    {
                        DataTable RowId = clDoc.ReturnTable(ConSale.ConnectionString, "Select ColumnId from Table_080_ReturnAmani where Column01=" + Table.Rows[0]["Row"].ToString());
                        dataSet_Sale5.EnforceConstraints = false;
        ...
        private void bindingNavigatorMoveNextItem_Click(object sender, EventArgs e)
        {
            if (this.table_080_ReturnAmaniBindingSource.Count > 0)
            {
                ...
                try
                {
                    ...
                    DataTable Table = clDoc.ReturnTable(ConSale.ConnectionString, "Select ISNULL((Select Min(Column01) from Table_080_ReturnAmani where Column01>" + ((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["Column01"].ToString() + "),0) as Row");
                    if (Table.Rows[0]["Row"].ToString() != "0")
                    {
                        DataTable RowId = clDoc.ReturnTable(ConSale.ConnectionString, "Select ColumnId from Table_080_ReturnAmani where Column01=" + Table.Rows[0]["Row"].ToString());
                        dataSet_Sale5.EnforceConstraints = false;
        ...
        private void bindingNavigatorMoveLastItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable Table = clDoc.ReturnTable(ConSale.ConnectionString, "Select ISNULL((Select max(Column01) from Table_080_ReturnAmani),0) as Row");
                if (Table.Rows[0]["Row"].ToString() != "0")
                {
                    DataTable RowId = clDoc.ReturnTable(ConSale.ConnectionString, "Select ColumnId from Table_080_ReturnAmani where Column01=" + Table.Rows[0]["Row"].ToString());
                    dataSet_Sale5.EnforceConstraints = false;
                ...
                if (this.table_080_ReturnAmaniBindingSource.Count > 0)
                {
                    if (UserScope.CheckScope(Class_BasicOperation._UserName, "Column11", 128))
                    {
                        _05_Sale.Reports.Form_SaleFactorTotalPrint frm = new Reports.Form_SaleFactorTotalPrint(
                                int.Parse(((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["Column01"].ToString()), false);
                        frm.ShowDialog();
                    }
                    else Class_BasicOperation.ShowMsg("", "کاربر گرامی شما امکان دسترسی به این فرم را ندارید", "Warning");
                }
        ...
        private void bt_ExportResid_Click(object sender, EventArgs e)
        {
            if (this.table_080_ReturnAmaniBindingSource.Count > 0)
            {
                ...
                try
                {
                    ...
                    if (clDoc.OperationalColumnValue("Table_080_ReturnAmani", "Column56", RowID) != 0)
                        throw new Exception("برای این فاکتور حواله صادر شده است");
                    if (clDoc.OperationalColumnValue("Table_080_ReturnAmani", "Column55", RowID) != 0)
                        throw new Exception("برای این فاکتور رسید صادر شده است");



                    if (clDoc.AllService(table_085_ReturnAmaniChildBindingSource))
                    ...
                    if (gridEX1.GetRow().Cells["Column58"].Text.Trim() != "" && gridEX1.GetRow().Cells["Column59"].Text.Trim() != "")
                    {
                        ...
                        _05_Sale.Frm_035_TransferInformationDialog frm = new Frm_035_TransferInformationDialog(this.table_085_ReturnAmaniChildBindingSource, ((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current),
                            ((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["Column02"].ToString(),
                            Table, Convert.ToInt16(((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["Column58"]),
                            Convert.ToInt16(((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["Column59"]));
                        frm.ShowDialog();
                    }
...
FROM         Table_011_PwhrsReceipt");
                ...
                int _ID = int.Parse(((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["ColumnId"].ToString());
                dataSet_Sale5.EnforceConstraints = false;
                this.table_080_ReturnAmaniTableAdapter.FillByID(this.dataSet_Sale5.Table_080_ReturnAmani, _ID);
                this.table_085_ReturnAmaniChildTableAdapter.FillBy_HeaderID(this.dataSet_Sale5.Table_085_ReturnAmaniChild, _ID);
                dataSet_Sale5.EnforceConstraints = true;
        ...
        private void bt_ExportDoc_Click(object sender, EventArgs e)
        {
            if (this.table_080_ReturnAmaniBindingSource.Count > 0)
            {
                try
                {
                    ...
                    if (((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["ColumnId"].ToString().StartsWith("-"))
                        Save_Event(sender, e);

                    string RowID = ((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["ColumnId"].ToString();

                    if (clDoc.OperationalColumnValue("Table_080_ReturnAmani", "Column57", RowID) != 0)
                    {
                        dataSet_Sale5.EnforceConstraints = false;
                        this.table_080_ReturnAmaniTableAdapter.FillByID(this.dataSet_Sale5.Table_080_ReturnAmani, int.Parse(RowID));
                        this.table_085_ReturnAmaniChildTableAdapter.FillBy_HeaderID(this.dataSet_Sale5.Table_085_ReturnAmaniChild, int.Parse(RowID));
...
FROM         Table_011_PwhrsReceipt");
                    ...
                    if (gridEX1.GetRow().Cells["Column58"].Text.Trim() != "" && gridEX1.GetRow().Cells["Column59"].Text.Trim() != "")
                    {
                        if (Row["Column56"].ToString().Trim() != "" && int.Parse(Row["Column56"].ToString()) > 0)
                        {
                            ...
                            {
                                _05_Sale.Frm_039_ExportDocInformationReturnAmaniFactor frm = new Frm_039_ExportDocInformationReturnAmaniFactor(true, false, false, int.Parse(Row["ColumnId"].ToString()), Convert.ToInt16(((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["Column58"]), Convert.ToInt16(((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["Column59"]));
                                frm.ShowDialog();
                            }
                            //سیستم دائمی
                            else
                            {
                                _05_Sale.Frm_039_ExportDocInformationReturnAmaniFactor frm = new Frm_039_ExportDocInformationReturnAmaniFactor(true, false, true, int.Parse(Row["ColumnId"].ToString()), Convert.ToInt16(((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["Column58"]), Convert.ToInt16(((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["Column59"]));
                                frm.ShowDialog();
                            }
                        ...
                        else
                        {
                            ...
                            if (!Class_BasicOperation._FinType)
                            {
                                _05_Sale.Frm_039_ExportDocInformationReturnAmaniFactor frm = new Frm_039_ExportDocInformationReturnAmaniFactor(true, _DraftPanel, false, int.Parse(Row["ColumnId"].ToString()), Convert.ToInt16(((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["Column58"]), Convert.ToInt16(((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["Column59"]));
                                frm.ShowDialog();
                            }
                            //سیستم دائمی
                            else
                            {
                                _05_Sale.Frm_039_ExportDocInformationReturnAmaniFactor frm = new Frm_039_ExportDocInformationReturnAmaniFactor(true, _DraftPanel, true, int.Parse(Row["ColumnId"].ToString()), Convert.ToInt16(((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["Column58"]), Convert.ToInt16(((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["Column59"]));
                                frm.ShowDialog();
                            }
                        }
                        dataSet_Sale5.EnforceConstraints = false;
...
FROM         Table_011_PwhrsReceipt");
        ...
        private void mnu_DelDraft_Click(object sender, EventArgs e)
        {
            ...
            if (this.table_080_ReturnAmaniBindingSource.Count > 0)
            {
                try
                {
                    int RowID = int.Parse(((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["ColumnId"].ToString());
                    int DraftId = clDoc.OperationalColumnValue("Table_080_ReturnAmani", "Column56", RowID.ToString());
...
FROM         Table_011_PwhrsReceipt");
        ...
        {
            string id = ((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["ColumnId"].ToString();
            ...
            string AmaniID = ((DataRowView)table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["ColumnId"].ToString();
            string command = string.Empty;
            ...
            command += " UPDATE  " + ConSale.Database + ".dbo.Table_080_ReturnAmani SET Column56=0 where ColumnId=" + AmaniID;
        ...
        private void bt_NotConfirmDraft_Click(object sender, EventArgs e)
        {
            if (this.table_080_ReturnAmaniBindingSource.Count > 0)
            {
                int DraftId = clDoc.OperationalColumnValue("Table_080_ReturnAmani", "Column56", ((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["ColumnId"].ToString());
                if (DraftId == 0)
                    return;
        ...
        private void mnu_DelRecipt_Click(object sender, EventArgs e)
        {
            if (this.table_080_ReturnAmaniBindingSource.Count > 0)
            {
                ...
                {
                    int RowID = int.Parse(((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["ColumnId"].ToString());
                    int ReceiptId = clDoc.OperationalColumnValue("Table_080_ReturnAmani", "Column55", RowID.ToString());
                    ...
                    if (ReceiptId != 0)
                    {
                        if (UserScope.CheckScope(Class_BasicOperation._UserName, "Column10", 20))
                        {
                            ...
                            clDoc.RunSqlCommand(ConSale.ConnectionString, @"update Table_080_ReturnAmani set column55=0 where columnid= " + RowID);
...
FROM         Table_011_PwhrsReceipt");
        ...
        private void bt_NotConfirmRecipt_Click(object sender, EventArgs e)
        {
            if (this.table_080_ReturnAmaniBindingSource.Count > 0)
            {
                int ReceiptId = clDoc.OperationalColumnValue("Table_080_ReturnAmani", "Column55", ((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["ColumnId"].ToString());
        ...
        private void mnu_Documents_Click(object sender, EventArgs e)
        {
            int SanadId = 0;
            if (this.table_080_ReturnAmaniBindingSource.Count > 0)
                SanadId = (((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["Column57"].ToString() == "" ? 0 : int.Parse(((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["Column57"].ToString()));
        ...
        private void bt_DelDoc_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (this.table_080_ReturnAmaniBindingSource.Count > 0)
                {
                    ...
                    int RowID = int.Parse(((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["ColumnId"].ToString());
                    int SanadID = int.Parse(((DataRowView)this.table_080_ReturnAmaniBindingSource.CurrencyManager.Current)["Column57"].ToString());
                    ...
                    if (SanadID != 0)
                    {
                        ...
                        if (DialogResult.Yes == MessageBox.Show(Message, "", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1, MessageBoxOptions.RightAlign))
                        {
                            ...
                            DataTable Table = clDoc.ReturnTable(ConAcnt.ConnectionString, "Select ColumnID from  Table_065_SanadDetail where Column00=" + SanadID + " and Column16=94 and Column17=" + RowID);
                            foreach (DataRow item in Table.Rows)
                            {
                                command += " Delete from Table_075_SanadDetailNotes where Column00=" + item["ColumnId"].ToString();
                            }

                            command += " Delete  from Table_065_SanadDetail where Column00=" + SanadID + " and Column16=94 and Column17=" + RowID;




                            command += " UPDATE " + ConSale.Database + ".dbo.Table_080_ReturnAmani SET Column57=0,Column15='" + Class_BasicOperation._UserName + "', Column16=getdate() where ColumnId=" + RowID;
