...
{
    public partial class Frm_008_ViewStoreSaleFactorsOLD : Form
    {
        ...
        public Frm_008_ViewStoreSaleFactorsOLD()
        {
            InitializeComponent();
        }
        ...
        private void Form_008_ViewSaleFactors_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                HeaderAdapter = new SqlDataAdapter(@"Select Table_010_SaleFactor.*,0 as CarryPrice from Table_010_SaleFactor   where Table_010_SaleFactor.columnid =1   ", ConSale);
                HeaderAdapter.Fill(dataSet1, "Header");
