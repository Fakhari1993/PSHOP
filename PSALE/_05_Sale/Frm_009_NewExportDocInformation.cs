...
{
    public partial class Frm_009_NewExportDocInformation : Form
    {
        ...
        public Frm_009_NewExportDocInformation(bool Tab1, bool Tab2, bool Tab3, int SaleID, Int16 Ware, Int16 Func)
        {
            InitializeComponent();
            _Tab1 = Tab1;
            _Tab2 = Tab2;
        ...
        private void Frm_009_NewExportDocInformation_Load(object sender, EventArgs e)
        {
            try
            {
              ...
              ,[Column06]      ,[Column07]      ,[Column08]      ,[Column09]      ,[Column10]      ,[Column11]    ,[Column12]      ,[Column13]      ,[Column14]      ,[Column15]      ,[Column16]      ,[Column17] ,[Column18]      ,[Column19]      ,[Column20]      ,[Column21]      ,[Column22],column23,column24) 
                 ...
                 Class_BasicOperation._UserName + "',getdate(),0," + (SaleRow["column24"] != null && !string.IsNullOrWhiteSpace(SaleRow["column24"].ToString()) ? SaleRow["column24"] : "0") + ",N'" + fa.Text + "');  ";
                            ...
                            else if (item.Cells["Type"].Value.ToString() == "26" && (Convert.ToDouble(item.Cells["Column11"].Value.ToString()) == 0 && Convert.ToDouble(item.Cells["Column12"].Value.ToString()) == 0))
                            {
                                ...
                                //                                    if (newDraft)
                                //                                    {
                                //                                        string[] _BesAccInfo = clDoc.ACC_Info(clDoc.Account(8, "Column13"));
                                ...
                                //                                @value ,(case when @value>0 then 0 else @TotalValue end),0,0,-1,26,@HavaleID  ,'" + Class_BasicOperation._UserName + "',getdate(),'" +
                                //                 Class_BasicOperation._UserName + @"',getdate(),0); set @value = 0
                                //                                        
                                //                                        INSERT INTO Table_065_SanadDetail ([Column00]      ,[Column01]      ,[Column02]      ,[Column03]      ,[Column04]      ,[Column05]
                                //              ,[Column06]      ,[Column07]      ,[Column08]      ,[Column09]      ,[Column10]      ,[Column11]    ,[Column12]      ,[Column13]      ,[Column14]      ,[Column15]      ,[Column16]      ,[Column17] ,[Column18]      ,[Column19]      ,[Column20]      ,[Column21]      ,[Column22]) 
                                //                    VALUES(@Key,'" + clDoc.Account(8, "Column13") + @"',
                                //                                " + Int16.Parse(_BesAccInfo[0].ToString()) + ",'" + _BesAccInfo[1].ToString() + @"',
                                //                                " + (string.IsNullOrEmpty(_BesAccInfo[2].ToString()) ? "NULL" : "'" + _BesAccInfo[2].ToString() + "'") + @",
                                //                                " + (string.IsNullOrEmpty(_BesAccInfo[3].ToString()) ? "NULL" : "'" + _BesAccInfo[3].ToString() + "'") + @",
                                //                                " + (string.IsNullOrEmpty(_BesAccInfo[4].ToString()) ? "NULL" : "'" + _BesAccInfo[4].ToString() + "'") + @",
                                //                                " + (string.IsNullOrWhiteSpace(item.Cells["Column07"].Text.Trim()) ? "NULL" : item.Cells["Column07"].Value.ToString()) + @",
                                //                                " + (string.IsNullOrWhiteSpace(item.Cells["Column08"].Text.Trim()) ? "NULL" : item.Cells["Column08"].Value.ToString()) + @",
                                //                               " + (string.IsNullOrWhiteSpace(item.Cells["Column09"].Text.Trim()) ? "NULL" : item.Cells["Column09"].Value.ToString()) + @",
                                //                               " + "'" + item.Cells["Column10"].Text.Trim() + @"',
        ...
        private void Frm_009_NewExportDocInformation_FormClosing(object sender, FormClosingEventArgs e)
        {
