                           ...
                           ROUND(SUM(TurnTable.TITotalWeight), 3) AS TITotalWeight,
                                         ...
                                         ROUND(
                                               ...
                                               ROUND(
                                                   ...
                                                   3
                                               ) AS TRTotalWeight ,dbo.table_004_CommodityAndIngredients.column26 AS property
                      FROM         (
...
CAST(0 AS float) AS INumberInBox,CAST(0 AS float) AS TINumberInBox, CAST(0 AS float) AS INumberInPack, CAST(0 AS float) AS TINumberInPack,
                  ...
                  CAST(0 AS FLOAT) AS ITotalWeight,CAST(0 AS FLOAT) AS TITotalWeight  
                      ...
                      {2}.dbo.Table_035_ProjectInfo ON dbo.Table_008_Child_PwhrsDraft.column14 = {2}.dbo.Table_035_ProjectInfo.Column00
                       ...
                       {2}.dbo.Table_035_ProjectInfo.Column02 
                  ...
                  ITotalWeight, SUM(Table_012_Child_PwhrsReceipt.column07) * isnull((
                    ...
                    WHERE     (dbo.Table_011_PwhrsReceipt.column02 <= '{0}') AND  (dbo.Table_011_PwhrsReceipt.column03 in ({1}))  GROUP BY dbo.Table_012_Child_PwhrsReceipt.column02, 
                    ...
                    GROUP BY dbo.table_004_CommodityAndIngredients.column26,TurnTable.GoodCode, dbo.table_004_CommodityAndIngredients.column02, dbo.table_004_CommodityAndIngredients.column01,dbo.table_004_CommodityAndIngredients.column07, TurnTable.Project, 
                    dbo.table_004_CommodityAndIngredients.column05, dbo.table_003_SubsidiaryGroup.column03, dbo.table_002_MainGroup.column02 having Round( SUM(TurnTable.ITotalNumber) - SUM(TurnTable.OTotalNumber),3)<0  ORDER BY dbo.table_004_CommodityAndIngredients.column02,dbo.table_004_CommodityAndIngredients.column01", ConWare);
...
{1}.dbo.Table_035_ProjectInfo.Column02 AS Project, SUM(dbo.Table_008_Child_PwhrsDraft.column04) AS ONumberInBox, 
                  ...
                  CAST(0 AS FLOAT) AS ITotalWeight,CAST(0 AS FLOAT) AS TITotalWeight    
                      ...
                      {1}.dbo.Table_035_ProjectInfo ON dbo.Table_008_Child_PwhrsDraft.column14 = {1}.dbo.Table_035_ProjectInfo.Column00
                       ...
                       @" GROUP BY dbo.Table_008_Child_PwhrsDraft.column02,dbo.Table_008_Child_PwhrsDraft.column14,
{1}.dbo.Table_035_ProjectInfo.Column02 
...
INNER JOIN
                    ...
                    GROUP BY dbo.table_004_CommodityAndIngredients.column26,TurnTable.GoodCode, dbo.table_004_CommodityAndIngredients.column02, dbo.table_004_CommodityAndIngredients.column01,dbo.table_004_CommodityAndIngredients.column07, TurnTable.Project,   
                      dbo.table_004_CommodityAndIngredients.column05, dbo.table_003_SubsidiaryGroup.column03, dbo.table_002_MainGroup.column02 having  Round(SUM(TurnTable.ITotalNumber) - SUM(TurnTable.OTotalNumber),3) <0  ORDER BY dbo.table_004_CommodityAndIngredients.column02,dbo.table_004_CommodityAndIngredients.column01"
                    ...
                    try
                    {
                        ...
                        if (pageSetupDialog1.ShowDialog() == DialogResult.OK)
                            if (printDialog1.ShowDialog() == DialogResult.OK)
                            {
                                ...
                                gridEXPrintDocument1.PageHeaderRight = " تا تاریخ " + faDatePicker1.Text +"***"+ " انبار: " + mlt_Ware.Text;
        ...
        {/*
            try
            {
                ...
                {
                    _05_Gozareshat.Frm_009_KardexTedadi frms = new _05_Gozareshat.Frm_009_KardexTedadi(
        ...
        {/*
            try
            {
                ...
                {
                    _05_Gozareshat.Frm_010_KardexRiyali frms = new _05_Gozareshat.Frm_010_KardexRiyali(
                        int.Parse(gridEX2.GetValue("GoodID").ToString()),
                        faDatePicker1.SelectedDateTime.Value.AddMonths(-2),
                        faDatePicker1.SelectedDateTime);
                    try
