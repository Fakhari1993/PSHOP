...
{
    public partial class Form_PreFactorPrint : Form
    {
        ...
        public Form_PreFactorPrint(int FactorNumber)
        {
            InitializeComponent();
            _FactorNumber = FactorNumber;
        }
        public Form_PreFactorPrint()
        {
            InitializeComponent();
        }
        ...
        private void bt_Display_Click(object sender, EventArgs e)
        {
            string HeaderSelectText = @" 
                            ...
                            FROM   (
                                       SELECT dbo.Table_007_FactorBefore.columnid AS FactorID,
                                              dbo.Table_007_FactorBefore.column01 AS Serial,
                                              0 AS LegalNumber,
                                              dbo.Table_007_FactorBefore.column02 AS Date,
                                              dbo.Table_007_FactorBefore.column03 AS CustomerID,
                                              ...
                                              dbo.Table_008_Child1_FactorBefore.column04 AS Box,
                                              dbo.Table_008_Child1_FactorBefore.column08 AS BoxPrice,
                                              dbo.Table_008_Child1_FactorBefore.column05 AS Pack,
                                              dbo.Table_008_Child1_FactorBefore.column09 AS PackPrice,
                                              dbo.Table_008_Child1_FactorBefore.column06 AS Number,
                                              dbo.Table_008_Child1_FactorBefore.column07 AS TotalNumber,
                                              dbo.Table_008_Child1_FactorBefore.column10 AS SinglePrice,
                                              dbo.Table_008_Child1_FactorBefore.column11 AS TotalPrice,
                                              dbo.Table_008_Child1_FactorBefore.column16 AS DiscountPercent,
                                              dbo.Table_008_Child1_FactorBefore.column17 AS DiscountPrice,
                                              dbo.Table_008_Child1_FactorBefore.column19 AS TaxPrice,
                                              Table_008_Child1_FactorBefore.Column20 AS DetailDescription,
                                              dbo.Table_008_Child1_FactorBefore.column21 AS NetPrice,
                                              GoodTable.column02 AS GoodName,
                                              OtherPrice.PlusPrice AS Ezafat,
                                              OtherPrice.MinusPrice AS Kosoorat,
                                              dbo.Table_007_FactorBefore.column05 AS Responsible,
                                              dbo.Table_007_FactorBefore.column06 AS DESCRIPTION,
                                              CountUnitTable.Column01 AS CountUnitName,
                                                dbo.Table_008_Child1_FactorBefore.column20 as GoodDesc,
                                                pp1.Column02 as CostCenter,
                                               pp.Column02 as Project

                                       FROM   dbo.Table_007_FactorBefore
                                              INNER JOIN dbo.Table_008_Child1_FactorBefore
                                                   ON  dbo.Table_007_FactorBefore.columnid = dbo.Table_008_Child1_FactorBefore.column01
                                              INNER JOIN (
                                                       SELECT ColumnId,
                                                              Column00,
                                                              Column01,
                                                   ...
                                                   ON  dbo.Table_007_FactorBefore.column03 = PersonTable.ColumnId
                                              LEFT OUTER JOIN (
                                                       SELECT columnid,
                                                       ...
                                                       FROM   (
                                                                  SELECT Table_007_FactorBefore_2.columnid,
                                                                         SUM(dbo.Table_009_Child2_FactorBefore.column04) AS 
                                                                         PlusPrice,
                                                                         0 AS MinusPrice
                                                                  FROM   dbo.Table_009_Child2_FactorBefore
                                                                         INNER JOIN dbo.Table_007_FactorBefore AS 
                                                                              Table_007_FactorBefore_2
                                                                              ON  dbo.Table_009_Child2_FactorBefore.column01 = 
                                                                                  Table_007_FactorBefore_2.columnid
                                                                  WHERE  (dbo.Table_009_Child2_FactorBefore.column05 = 0)
                                                                  GROUP BY
                                                                         Table_007_FactorBefore_2.columnid,
                                                                         dbo.Table_009_Child2_FactorBefore.column05
                                                                  UNION ALL
                                                                  SELECT Table_007_FactorBefore_1.columnid,
                                                                         0 AS PlusPrice,
                                                                         SUM(Table_009_Child2_FactorBefore_1.column04) AS 
                                                                         MinusPrice
                                                                  FROM   dbo.Table_009_Child2_FactorBefore AS 
                                                                         Table_009_Child2_FactorBefore_1
                                                                         INNER JOIN dbo.Table_007_FactorBefore AS 
                                                                              Table_007_FactorBefore_1
                                                                              ON  
                                                                                  Table_009_Child2_FactorBefore_1.column01 = 
                                                                                  Table_007_FactorBefore_1.columnid
                                                                  WHERE  (Table_009_Child2_FactorBefore_1.column05 = 1)
                                                                  GROUP BY
                                                                         Table_007_FactorBefore_1.columnid,
                                                                         Table_009_Child2_FactorBefore_1.column05
                                                              ) AS OtherPrice_1
                                                       GROUP BY
                                                              columnid
                                                   ) AS OtherPrice
                                                   ON  dbo.Table_007_FactorBefore.columnid = OtherPrice.columnid
                                              LEFT OUTER JOIN (
                                                       SELECT columnid,
                                                              column01,
                                                              column02,
                                                   ...
                                                   ON  dbo.Table_008_Child1_FactorBefore.column02 = 
                                                       GoodTable.columnid
                                              LEFT OUTER JOIN (
                                                       SELECT Column00,
                                                              Column01
                                                   ...
                                                   ON  dbo.Table_008_Child1_FactorBefore.column03 = 
                                                       CountUnitTable.Column00

                                       left join " + ConBase.Database + @".dbo.Table_035_ProjectInfo pp on pp.Column00= dbo.Table_008_Child1_FactorBefore.column23 
                                      left join " + ConBase.Database + @".dbo.Table_030_ExpenseCenterInfo pp1 on pp1.Column00= dbo.Table_008_Child1_FactorBefore.column22
                                   ) AS FactorTable
                                   INNER JOIN (
                                            SELECT column01,
                                                   SUM(column21) AS NetTotal
                                            FROM   dbo.Table_008_Child1_FactorBefore AS 
                                                   Table_008_Child1_FactorBefore_1
                                            GROUP BY
                                                   column01
                                        ) AS derivedtbl_2
                                        ON  FactorTable.FactorID = derivedtbl_2.column01
                                   LEFT OUTER JOIN (
                                            SELECT PersonId,
                                                   Groups
...
";
            ...
            string DetailSelectText = @"SELECT     dbo.Table_024_Discount.column01 AS Name, dbo.Table_009_Child2_FactorBefore.column04 AS Price, 
                      CASE WHEN Table_024_Discount.column02 = 0 THEN '+' ELSE '-' END AS Type, dbo.Table_009_Child2_FactorBefore.column01 AS Column01 ,
                      dbo.Table_007_FactorBefore.column01 AS HeaderNum, dbo.Table_007_FactorBefore.column02 AS HeaderDate, dbo.Table_009_Child2_FactorBefore.column06 as desc2
                      FROM         dbo.Table_009_Child2_FactorBefore INNER JOIN
                      dbo.Table_007_FactorBefore ON dbo.Table_009_Child2_FactorBefore.column01 = dbo.Table_007_FactorBefore.columnid LEFT OUTER JOIN
                      dbo.Table_024_Discount ON dbo.Table_009_Child2_FactorBefore.column02 = dbo.Table_024_Discount.columnid";


            //if (rdb_CurrentNumber.Checked)d
            //{
            HeaderSelectText += " WHERE     (FactorTable.Serial = " + txt_Number.Text + ")";
            DetailSelectText += " WHERE (Table_007_FactorBefore.Column01= " + txt_Number.Text + ")";
            //}
            ...
            SqlDataAdapter Adapter = new SqlDataAdapter("Select * from Table_007_FactorBefore where Column01=" + _FactorNumber, ConSale);
            Table = new DataTable();
            Adapter.Fill(Table);
