...
{
    public partial class Form_TotalSaleFactorPrint : Form
    {
        ...
        public Form_TotalSaleFactorPrint(int SaleNumber, bool ClubPrint)
        {
            InitializeComponent();
        ...
        public Form_TotalSaleFactorPrint(List<string> _List, bool ClubPrint)
        {
            InitializeComponent();
            List = _List;
            _ClubPrint = ClubPrint;
        ...
        public Form_TotalSaleFactorPrint(DataTable _HeaderTable, DataTable _DetailTable, bool ClubPrint)
        {
            InitializeComponent();
            ...
            if (!_Agg)
            {
                ...
                if (!_ClubPrint)
                {
                    HeaderSelectText = @"  SELECT     FactorTable.FactorID AS ID,DetailId, FactorTable.Serial, FactorTable.LegalNumber, FactorTable.Date, FactorTable.Responsible, FactorTable.CustomerID, FactorTable.P2Name, 
                                ...
                                FactorTable.NumberInPack, CityTable.Column02 AS CityName, ProvinceTable.Column01 AS ProvinceName,FactorTable.PayCash,FactorTable.DraftNumber,FactorTable.DocID,FactorTable.Feild, FactorTable.GoodDesc,FactorTable.Column35 as ExpDate,FactorTable.Column34 as BuildSeri,FactorTable.SaleCondition,FactorTable.Ware
                                ...
                                Table_010_SaleFactor.Column10 as DocId, dbo.Table_011_Child1_SaleFactor.Column23 AS GoodDesc, dbo.Table_011_Child1_SaleFactor.column34, dbo.Table_011_Child1_SaleFactor.column35,dbo.Table_010_SaleFactor.column04 AS SaleCondition,tp.column02 AS Ware
FROM         dbo.Table_010_SaleFactor
        ...
        private void bt_custom14_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                stireport.Load("TotalCustomReport.mrt");
        ...
        private void btn_Design_Click_1(object sender, EventArgs e)
        {
