...
{
    public partial class Frm_008_ViewSettelSaleFactors : Form
    {
        ...
        public Frm_008_ViewSettelSaleFactors()
        {
            InitializeComponent();
        }
        ...
        {
            // TODO: This line of code loads data into the 'dataSet_Report.Table_034_SaleFactor_Child3' table. You can move, or remove it, as needed.
            ...
            dt.Rows.Add(1, "نقد");
            dt.Rows.Add(2, "چک");
            dt.Rows.Add(3, "اعتباری");
            dt.Rows.Add(4, "ارجاع");
            dt.Rows.Add(5, "از فاکتور");
            dt.Rows.Add(6, "به فاکتور");
            gridEX_List.DropDowns[0].DataSource = dt;
            ...
            gridEX_List.DropDowns["Bank"].SetDataBinding(BankTable, "");
            ...
            gridEX_List.DropDowns["Project"].SetDataBinding(ProjectTable, "");

            DataTable DocTable = clDoc.ReturnTable(ConAcnt.ConnectionString, "Select ColumnId,Column00 from Table_060_SanadHead");
            gridEX_List.DropDowns["Doc"].SetDataBinding(DocTable, "");
             

            DataTable HeadersTable = clDoc.ReturnTable(ConAcnt.ConnectionString, "Select ACC_Code,ACC_Name from AllHeaders()");
            gridEX_List.DropDowns["Bed"].SetDataBinding(HeadersTable, "");
            gridEX_List.DropDowns["Bes"].SetDataBinding(HeadersTable, "");

            //gridEX_Pay
            gridEX_List.DropDowns["CashBank"].SetDataBinding(BankTable, "");
             
            gridEX_List.DropDowns["Project"].SetDataBinding(ProjectTable, "");
            gridEX_List.DropDowns["status"].SetDataBinding(clDoc.ReturnTable(ConBank.ConnectionString, "Select ColumnId,Column02 from Table_060_ChequeStatus where Column01=0"), "");
          
  
            gridEX_List.DropDowns["Bank2"].SetDataBinding(clDoc.ReturnTable(ConBank.ConnectionString, "Select Column00,Column01 from Table_010_BankNames"), "");
            gridEX_List.DropDowns["Bank"].SetDataBinding(clDoc.ReturnTable(ConBank.ConnectionString, "Select Column00,Column01 from Table_010_BankNames"), "");



            string[] Dates = Properties.Settings.Default.ViewSettelSaleFactors.Split('-');
...
isnull(" + ConWare.Database + @".dbo.Table_007_PwhrsDraft.Column22,0) as CarryPrice,' ' as EditDate from Table_010_SaleFactor left outer join " + ConWare.Database + @".dbo.Table_007_PwhrsDraft
on Table_010_SaleFactor.column09=" + ConWare.Database + @".dbo.Table_007_PwhrsDraft.columnid where  dbo.Table_010_SaleFactor.columnid in (select column01 from dbo.Table_034_SaleFactor_Child3 ) and
            Table_010_SaleFactor.Column02>='" + faDatePickerStrip1.FADatePicker.Text + "' and Table_010_SaleFactor.Column02<='" + faDatePickerStrip2.FADatePicker.Text + "'  ", ConSale);
            HeaderAdapter.Fill(dataSet1, "Header");

            Child1Adapter = new SqlDataAdapter(@"SELECT     dbo.Table_034_SaleFactor_Child3.*    FROM         dbo.Table_010_SaleFactor INNER JOIN
            dbo.Table_034_SaleFactor_Child3 ON dbo.Table_010_SaleFactor.columnid = dbo.Table_034_SaleFactor_Child3.column01 WHERE     (dbo.Table_010_SaleFactor.column02 >='" + faDatePickerStrip1.FADatePicker.Text + "' and dbo.Table_010_SaleFactor.column02<='" + faDatePickerStrip2.FADatePicker.Text + "')  ", ConSale);
        ...
        private void bt_Search_Click(object sender, EventArgs e)
        {
            if (faDatePickerStrip1.FADatePicker.SelectedDateTime.HasValue && faDatePickerStrip2.FADatePicker.SelectedDateTime.HasValue && faDatePickerStrip2.FADatePicker.Text.Length == 10 && faDatePickerStrip1.FADatePicker.Text.Length == 10)
            {
                ...
                on Table_010_SaleFactor.column09=" + ConWare.Database + @".dbo.Table_007_PwhrsDraft.columnid 
                 
                where dbo.Table_010_SaleFactor.columnid in (select column01 from dbo.Table_034_SaleFactor_Child3 ) and  Table_010_SaleFactor.Column02>='" + faDatePickerStrip1.FADatePicker.Text + "' and Table_010_SaleFactor.Column02<='" + faDatePickerStrip2.FADatePicker.Text + "'     ", ConSale);
                HeaderAdapter.Fill(dataSet1, "Header");
        ...
        private void Form_008_ViewSaleFactors_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                ...
                if (faDatePickerStrip1.FADatePicker.SelectedDateTime.HasValue && faDatePickerStrip2.FADatePicker.SelectedDateTime.HasValue)
                    Properties.Settings.Default.ViewSettelSaleFactors = faDatePickerStrip1.FADatePicker.Text + "-" + faDatePickerStrip2.FADatePicker.Text;
                    ...
                    if (this.gridEX_Header.GetCheckedRows().Length > 0)
                    {
                        if (UserScope.CheckScope(Class_BasicOperation._UserName, "Column11", 128))
                        {
                            ...
                            if (CustomerTable.Rows.Count > 0)
                            {
                                ...
                                //_05_Sale.Reports.Form_SaleFactorPrint frm = new _05_Sale.Reports.Reports.Form_SaleFactorPrint(HeaderTable, DetailTable, false);
                                //frm.ShowDialog();
