...
{
    public partial class Frm_029_NewCloseCash : Form
    {
        ...
        private void bt_ExportDoc_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (gx_factors.GetRows().Length > 0)
                {
                    ...
                    { /*
                        ...
                        {
                            _05_Sale.GoodList frm1 = new GoodList(NotExist, "لیست کالاهای ناموجود برای حواله های صادر شده");
                            frm1.ShowDialog();
                        }
                        if (NotExist.Rows.Count == 0)
                        {
           ...
           ,[Column35]) VALUES(@draftkey," + item1["Column02"].ToString() + "," +
              ...
              ,[Column06]      ,[Column07]      ,[Column08]      ,[Column09]      ,[Column10]      ,[Column11]    ,[Column12]      ,[Column13]      ,[Column14]      ,[Column15]      ,[Column16]      ,[Column17] ,[Column18]      ,[Column19]      ,[Column20]      ,[Column21]      ,[Column22],[Column23],[Column24]) 
                ...
                VALUES((Select Isnull((Select Max(Column00) from Table_060_SanadHead),0))+1,'" + faDatePickerStrip1.FADatePicker.Text + "',2,0,'صدور سند بستن صندوق','" + Class_BasicOperation._UserName +
                            "',getdate()); SET @DocID=SCOPE_IDENTITY()";
              ...
              ,[Column06]      ,[Column07]      ,[Column08]      ,[Column09]      ,[Column10]      ,[Column11]    ,[Column12]      ,[Column13]      ,[Column14]      ,[Column15]      ,[Column16]      ,[Column17] ,[Column18]      ,[Column19]      ,[Column20]      ,[Column21]      ,[Column22],[Column23],[Column24]) 
                   ...
                   " + "'بابت واریز/برداشت روزانه از صندوق'," + Convert.ToInt64(item.Cells["Column04"].Value) + @",0,0,0,-1,100," + ((DataRowView)this.table_96_CloseCashBindingSource.CurrencyManager.Current)["ColumnId"] + @",'" + Class_BasicOperation._UserName + "',getdate(),'" +
                                                  Class_BasicOperation._UserName + "',getdate(),0,0,NULL);  ";
              ...
              ,[Column06]      ,[Column07]      ,[Column08]      ,[Column09]      ,[Column10]      ,[Column11]    ,[Column12]      ,[Column13]      ,[Column14]      ,[Column15]      ,[Column16]      ,[Column17] ,[Column18]      ,[Column19]      ,[Column20]      ,[Column21]      ,[Column22],[Column23],[Column24]) 
                    VALUES(@DocID,'" + acc + @"',
                                ...
                                " + (string.IsNullOrEmpty(_AccInfo[4].ToString()) ? "NULL" : "'" + _AccInfo[4].ToString() + "'") + @",
                                NULL, NULL , NULL ,
                   " + "'واریز/برداشت روزانه صندوق'," + Convert.ToInt64(item.Cells["Column03"].Value) + @",0,0,0,-1,100," + ((DataRowView)this.table_96_CloseCashBindingSource.CurrencyManager.Current)["ColumnId"] + @",'" + Class_BasicOperation._UserName + "',getdate(),'" +
                                                  Class_BasicOperation._UserName + "',getdate(),0,0,NULL);  ";
              ...
              ,[Column06]      ,[Column07]      ,[Column08]      ,[Column09]      ,[Column10]      ,[Column11]    ,[Column12]      ,[Column13]      ,[Column14]      ,[Column15]      ,[Column16]      ,[Column17] ,[Column18]      ,[Column19]      ,[Column20]      ,[Column21]      ,[Column22],[Column23],[Column24]) 
                    VALUES(@DocID,'" + acc.Rows[0]["column08"].ToString() + @"',
                                ...
                                " + (string.IsNullOrEmpty(_AccInfo[4].ToString()) ? "NULL" : "'" + _AccInfo[4].ToString() + "'") + @",
                                NULL, NULL , NULL ,
                   " + "'بابت واریز/برداشت روزانه از صندوق' " + ",0," + Convert.ToInt64(customerrecive + losefromcash) + @",0,0,-1,100," + ((DataRowView)this.table_96_CloseCashBindingSource.CurrencyManager.Current)["ColumnId"] + @",'" + Class_BasicOperation._UserName + "',getdate(),'" +
                                              Class_BasicOperation._UserName + "',getdate(),0,0,NULL);  ";
              ...
              ,[Column06]      ,[Column07]      ,[Column08]      ,[Column09]      ,[Column10]      ,[Column11]    ,[Column12]      ,[Column13]      ,[Column14]      ,[Column15]      ,[Column16]      ,[Column17] ,[Column18]      ,[Column19]      ,[Column20]      ,[Column21]      ,[Column22],[Column23],[Column24]) 
                    VALUES(@DocID,'" + acc.Rows[0]["column08"].ToString() + @"',
                                ...
                                " + (string.IsNullOrEmpty(_AccInfo[4].ToString()) ? "NULL" : "'" + _AccInfo[4].ToString() + "'") + @",
                                NULL, NULL , NULL ,
                   " + "'بابت کسر و اضافه صندوق'," + Convert.ToInt64(Math.Abs(CashDeductionAddition)) + @",0,0,0,-1,100," + ((DataRowView)this.table_96_CloseCashBindingSource.CurrencyManager.Current)["ColumnId"] + @",'" + Class_BasicOperation._UserName + "',getdate(),'" +
                                                  Class_BasicOperation._UserName + "',getdate(),0,0,NULL);  ";
              ...
              ,[Column06]      ,[Column07]      ,[Column08]      ,[Column09]      ,[Column10]      ,[Column11]    ,[Column12]      ,[Column13]      ,[Column14]      ,[Column15]      ,[Column16]      ,[Column17] ,[Column18]      ,[Column19]      ,[Column20]      ,[Column21]      ,[Column22],[Column23],[Column24]) 
                    VALUES(@DocID,'" + ddt.Rows[0]["bes"].ToString() + @"',
                                ...
                                " + (string.IsNullOrEmpty(_AccInfo[4].ToString()) ? "NULL" : "'" + _AccInfo[4].ToString() + "'") + @",
                                NULL, NULL , NULL ,
                   " + "'بابت کسر و اضافه صندوق'," + "0," + Convert.ToInt64(Math.Abs(CashDeductionAddition)) + @",0,0,-1,100," + ((DataRowView)this.table_96_CloseCashBindingSource.CurrencyManager.Current)["ColumnId"] + @",'" + Class_BasicOperation._UserName + "',getdate(),'" +
                                                  Class_BasicOperation._UserName + "',getdate(),0,0,NULL);  ";
              ...
              ,[Column06]      ,[Column07]      ,[Column08]      ,[Column09]      ,[Column10]      ,[Column11]    ,[Column12]      ,[Column13]      ,[Column14]      ,[Column15]      ,[Column16]      ,[Column17] ,[Column18]      ,[Column19]      ,[Column20]      ,[Column21]      ,[Column22],[Column23],[Column24]) 
                    VALUES(@DocID,'" + ddt.Rows[0]["bed"].ToString() + @"',
                                ...
                                " + (string.IsNullOrEmpty(_AccInfo[4].ToString()) ? "NULL" : "'" + _AccInfo[4].ToString() + "'") + @",
                                NULL, NULL , NULL ,
                   " + "'بابت اختلاف حساب صندوق'," + Convert.ToInt64(Math.Abs(CashAcountDifference)) + @",0,0,0,-1,100," + ((DataRowView)this.table_96_CloseCashBindingSource.CurrencyManager.Current)["ColumnId"] + @",'" + Class_BasicOperation._UserName + "',getdate(),'" +
                                                  Class_BasicOperation._UserName + "',getdate(),0,0,NULL);  ";
              ...
              ,[Column06]      ,[Column07]      ,[Column08]      ,[Column09]      ,[Column10]      ,[Column11]    ,[Column12]      ,[Column13]      ,[Column14]      ,[Column15]      ,[Column16]      ,[Column17] ,[Column18]      ,[Column19]      ,[Column20]      ,[Column21]      ,[Column22],[Column23],[Column24]) 
                    VALUES(@DocID,'" + acc.Rows[0]["column08"].ToString() + @"',
                                ...
                                " + (string.IsNullOrEmpty(_AccInfo[4].ToString()) ? "NULL" : "'" + _AccInfo[4].ToString() + "'") + @",
                                NULL, NULL , NULL ,
                   " + "'بابت اختلاف حساب صندوق'," + "0," + Convert.ToInt64(Math.Abs(CashAcountDifference)) + @",0,0,-1,100," + ((DataRowView)this.table_96_CloseCashBindingSource.CurrencyManager.Current)["ColumnId"] + @",'" + Class_BasicOperation._UserName + "',getdate(),'" +
                                                  Class_BasicOperation._UserName + "',getdate(),0,0,NULL);  ";
              ...
              ,[Column06]      ,[Column07]      ,[Column08]      ,[Column09]      ,[Column10]      ,[Column11]    ,[Column12]      ,[Column13]      ,[Column14]      ,[Column15]      ,[Column16]      ,[Column17] ,[Column18]      ,[Column19]      ,[Column20]      ,[Column21]      ,[Column22],[Column23],[Column24]) 
                   ...
                   " + "'بابت اختلاف حساب صندوق'," + "0," + Convert.ToInt64(Math.Abs(CashAcountDifference)) + @",0,0,-1,100," + ((DataRowView)this.table_96_CloseCashBindingSource.CurrencyManager.Current)["ColumnId"] + @",'" + Class_BasicOperation._UserName + "',getdate(),'" +
                                        ...
                                        using (SqlConnection Con1 = new SqlConnection(Properties.Settings.Default.ACNT))
                                        {
                                            ...
                                            try
                                            {
                                                closcmd += " update " + ConSale.Database + ".dbo.Table_010_SaleFactor set column53=1,Column62='" + Class_BasicOperation._UserName + "',Column63=getdate() where columnid in  (" + upcmd.TrimEnd(',') + ")";
                                                closcmd += " update " + ConSale.Database + ".dbo.Table_018_MarjooiSale set Column27=1 where column02<='" + faDatePickerStrip1.FADatePicker.Text + "'";
                                                ...
                                                //{
                                                //    MessageBox.Show("محاسبه ارزش حواله فاکتور/های زیر با خطا مواجه شد و بستن صندوق برای این فاکتور/ها انجام نشد" + Environment.NewLine + notset.TrimEnd(','));
                                                //}
                                                //else if (!string.IsNullOrWhiteSpace(notset) && Class_BasicOperation._FinType)
                                                //    MessageBox.Show("محاسبه ارزش حواله و صدور سند بهای تمام شده ی فاکتور/های زیر با خطا مواجه شد و بستن صندوق برای این فاکتور/ها انجام نشد" + Environment.NewLine + notset.TrimEnd(','));
                                                //else
...
WHERE      column02<='" + faDatePickerStrip1.FADatePicker.Text + @"'     and column53=0 and column19=0 and column17=0
                                                                             ", ConSale);
                    ...
                    Adapter = new SqlDataAdapter(
                         ...
                         Column35, Column36, Column41, Column46, Column47, Column48, Column52,Column28 - Column29 -Column30 - Column31 + Column32- Column33 as FinalPrice
FROM            Table_010_SaleFactor
WHERE      column02<='" + faDatePickerStrip1.FADatePicker.Text + @"'     and column53=0 and column19=0 and column17=0 and (Column10=0 or Column09=0)
                                                                             ", ConSale);
                    Adapter.Fill(error);
                    ...
                    {
                        Class_BasicOperation.ShowMsg("", "فاکتورهای زیر سند/حواله ندارند، برای بستن صندوق ابتدا برای این فاکتورها صدور سند و حواله انجام دهید" + Environment.NewLine + error1.TrimEnd(','), "Stop");
                        return;
        ...
        private void bt_New_Click(object sender, EventArgs e)
        {
            try
            {
                if (gx_factors.GetDataRows().Count() <= 0)
                {
                ...
                DataTable InfoTable = clDoc.ReturnTable(Properties.Settings.Default.SALE, @"SELECT (
                                                                                       ...
                                                                                       (
                                                                                        ...
                                                                                        WHERE  tsd.Column01 IN (SELECT column08
                                                                                                                ...
                                                                                                                WHERE  tst.Column21 = 1)  AND tsh.Column01 <= '" + faDatePickerStrip1.FADatePicker.Text + @"'
