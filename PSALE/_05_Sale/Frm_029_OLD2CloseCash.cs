...
namespace PSHOP._05_Sale
{
    ...
    /// </summary>
    public partial class Frm_029_OLD2CloseCash : Form
    {
                    ...
                    if (faDatePickerStrip1.FADatePicker.Text != string.Empty)
                    {
                        ...
                        if (NotExist.Rows.Count == 0)
                        {
                            ...
                            else
                            {
                                ...
                                #region صدور سند فاکتور فروش و حواله
                                            ...
                                            foreach (DataRow ar1 in ArzeshTable.Rows)
                                            {
                                                ...
                                                try
                                                {
                                                    ...
                                                    foreach (DataRow item2 in Table.Rows)
                                                    {
                                                        ...
                                                        {
                                                            Adapter = new SqlDataAdapter("EXEC	 " + (Class_BasicOperation._WareType ? "[dbo].[PR_00_NewFIFO] " : " [dbo].[PR_05_AVG] ") + "  @GoodParameter = " + item2["Column02"].ToString() + ", @WareCode = " + ar2["ware"].ToString(), Con);
                                            ...
                                            using (SqlConnection Con1 = new SqlConnection(Properties.Settings.Default.ACNT))
                                            {
                                                ...
                                                try
                                                {
                                                    if (ok)
                                                    {
                                                        ...
                                                        closcmd += " update " + ConSale.Database + ".dbo.Table_018_MarjooiSale set Column27=1,Column31=" + ((DataRowView)this.table_96_CloseCashBindingSource.CurrencyManager.Current)["ColumnId"] + " where column02<='" + faDatePickerStrip1.FADatePicker.Text + "'    AND ( Column30=" + projectId + " or '" + (Isadmin) + @"'=N'True')";
...
WHERE      column02<='" + faDatePickerStrip1.FADatePicker.Text + @"'     and column53=0 and column19=0 and column17=0 
                    ...
                    //                         Column35, Column36, Column41, Column46, Column47, Column48, Column52,Column28 - Column29 -Column30 - Column31 + Column32- Column33 as FinalPrice
                    //FROM            Table_010_SaleFactor
                    //WHERE      column02<='" + faDatePickerStrip1.FADatePicker.Text + @"'     and column53=0 and column19=0 and column17=0 and (Column10=0 or Column09=0) AND ( Column44=" + projectId + " or '" + (Isadmin) + @"'=N'True')
                    //                                                                             ", ConSale);
                    //                    Adapter.Fill(error);
        ...
        private void chehckessentioal()
        {
            ...
            if (Class_BasicOperation._FinType)///سیستم دائمی
            {
                ...
                Adapter1 = new SqlDataAdapter(@" SELECT  
                                                                           tsf.columnid,tsf.column01, tsf.Column09, tsf.Column10 as DocID,dff.column02 as date,dff.column03 as ware,tsf.Column44 Project
                                                                    FROM   Table_010_SaleFactor tsf left join " + ConWare.Database + @".dbo.Table_007_PwhrsDraft dff on dff.columnid=tsf.Column09
                                                                    WHERE   (
                                                                               tsf.column02 <= '" + faDatePickerStrip1.FADatePicker.Text + @"'
                                                                           )
