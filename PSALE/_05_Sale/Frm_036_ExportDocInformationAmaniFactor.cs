...
{
    public partial class Frm_036_ExportDocInformationAmaniFactor : Form
    {
        ...
        bool newDraft = false;
        public Frm_036_ExportDocInformationAmaniFactor(bool Tab1, bool Tab2, bool Tab3, int SaleID, Int16 WareDraft, Int16 WareRecipt)
        {
            InitializeComponent();
            _Tab1 = Tab1;
            _Tab2 = Tab2;
        ...
        private void Frm_009_ExportDocInformation_Load(object sender, EventArgs e)
        {
            ...
            //*********************
            SaleAdapter = new SqlDataAdapter("Select * from Table_070_AmaniFactor where ColumnId=" + _SaleID, ConSale);
            ...
            Child1Adapter = new SqlDataAdapter("Select *,CAST(0 as decimal(18, 4)) as UnitValue,CAST(0 as decimal(18, 4)) as TotalValue from Table_075_Child_AmaniFactor where Column01=" + _SaleID, ConSale);
            ...
            mlt_WareRecipt.Value = SaleRow["Column59"].ToString();
                ...
                mlt_SaleBed.Value = clDoc.Account(47, "Column07");
                mlt_SaleBes.Value = clDoc.Account(47, "Column13");
            ...
            mlt_WareDraft.Value = wareDraft;
            mlt_WareRecipt.Value = wareRecipt;
        ...
        private void PrepareDoc()
        {
            ...
            if (chk_Baha.Checked)
            {
                ...
                Adapter = new SqlDataAdapter(@" SELECT * FROM  [Table_075_Child_AmaniFactor]
                ...
                if (Project.Rows.Count > 0)//////////کالاها پروژه دارند
                {
                    Adapter = new SqlDataAdapter(@"SELECT      Project,Total, Discount, Adding, column01, Total - Discount + Adding AS Net,TotalValue
                             ...
                             FROM          dbo.Table_075_Child_AmaniFactor
                    ...
                    Adapter = new SqlDataAdapter(@"SELECT  tcsf.column11,tcsf.column07,tcsf.column10,tcsf.column11-tcsf.column17+tcsf.column19 as Net,
                                            ...
                                            FROM   Table_075_Child_AmaniFactor tcsf
                    ...
                    if (chk_RegisterGoods.Checked)//ریز اقلام
                    {
                        foreach (DataRow dt in detali.Rows)
                        {
                            ...
                            if (!chk_Net.Checked)
                            {
                                SourceTable.Rows.Add(93, (mlt_SaleBed.Text.Trim() != "" ? mlt_SaleBed.Value.ToString() : null),
                            ...
                            0, 0, -1);
                                ...
                                SourceTable.Rows.Add(93, (mlt_SaleBes.Text.Trim() != "" ? mlt_SaleBes.Value.ToString() : null),
                    ...
                    else
                    {
                        foreach (DataRow item in Table.Rows)
                        {
                            ...
                            {
                                //*********Bes
                                SourceTable.Rows.Add(93, (mlt_SaleBes.Text.Trim() != "" ? mlt_SaleBes.Value.ToString() : null), (mlt_SaleBes.Text.Trim() != "" ? mlt_SaleBes.Value.ToString() : null),
                                    null, null,
                   ...
                   "Select SUM(column19) as ezafe, column22 from Table_075_Child_AmaniFactor where column01=" + SaleRow["ColumnId"].ToString() + "  group by column22");
                        foreach (DataRow d in ezafeTable.Rows)
                        {
                            if (Convert.ToDouble(d["ezafe"].ToString()) != 0)
                            {
                                //********Bed
                                SourceTable.Rows.Add(93, (mlt_LinAddBed.Text.Trim() != "" ? mlt_LinAddBed.Value.ToString() : null),
                                    (mlt_LinAddBed.Text.Trim() != "" ? mlt_LinAddBed.Value.ToString() : null), SaleRow["Column03"].ToString(),
                                    null, ((d["column22"] != DBNull.Value && d["column22"] != null && !string.IsNullOrWhiteSpace(d["column22"].ToString())) ? d["column22"].ToString() : null), (Convert.ToDouble(SaleRow["Column34"].ToString()) > 0 ? "اضافه خطی فاکتور فروش امانی ش " : "تخفیف خطی2 فاکتور فروش امانی ش ") +
                                    SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(),
                                    Math.Abs(Convert.ToDouble(d["ezafe"].ToString())), 0, 0, -1);
                                //*********Bes
                                SourceTable.Rows.Add(93, (mlt_LinAddBes.Text.Trim() != "" ? mlt_LinAddBes.Value.ToString() : null),
                                    ...
                                    (Convert.ToDouble(SaleRow["Column34"].ToString()) > 0 ? "اضافه خطی فاکتور فروش امانی ش " : "تخفیف خطی2 فاکتور فروش امانی ش ")
                                    + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(),
                    ...
                    if (Convert.ToDouble(SaleRow["Column35"].ToString()) > 0 && !chk_Net.Checked)
                    {
                        DataTable takhfifTable = clDoc.ReturnTable(ConSale.ConnectionString,
                            "Select SUM(column17) as takhfif, column22 from Table_075_Child_AmaniFactor where column01=" + SaleRow["ColumnId"].ToString() + "  group by column22");
                        ...
                        foreach (DataRow h in takhfifTable.Rows)
                        {
                            ...
                            {
                                //********Bed
                                SourceTable.Rows.Add(93, (mlt_LinDisBed.Text.Trim() != "" ? mlt_LinDisBed.Value.ToString() : null), (mlt_LinDisBed.Text.Trim() != "" ? mlt_LinDisBed.Value.ToString() : null), null, null, ((h["column22"] != DBNull.Value && h["column22"] != null && !string.IsNullOrWhiteSpace(h["column22"].ToString())) ? h["column22"].ToString() : null), "تخفیف خطی فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), Convert.ToDouble(h["takhfif"].ToString()), 0, 0, -1);
                                //*********Bes
                                SourceTable.Rows.Add(93, (mlt_LinDisBes.Text.Trim() != "" ? mlt_LinDisBes.Value.ToString() : null), (mlt_LinDisBes.Text.Trim() != "" ? mlt_LinDisBes.Value.ToString() : null), SaleRow["Column03"].ToString(), null, ((h["column22"] != DBNull.Value && h["column22"] != null && !string.IsNullOrWhiteSpace(h["column22"].ToString())) ? h["column22"].ToString() : null), "تخفیف خطی فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), 0, Convert.ToDouble(h["takhfif"].ToString()), 0, -1);
                            }
                        }
                    ...
                    //{
                    //    //********Bed
                    //    SourceTable.Rows.Add(93, (mlt_DisBed.Text.Trim() != "" ? mlt_DisBed.Value.ToString() : null), (mlt_DisBed.Text.Trim() != "" ? mlt_DisBed.Value.ToString() : null), null, null, null, "تخفیف حجمی گروه مشتری- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), Convert.ToDouble(SaleRow["Column29"].ToString()), 0, 0, -1);
                    //    //*********Bes
                    //    SourceTable.Rows.Add(93, (mlt_DisBes.Text.Trim() != "" ? mlt_DisBes.Value.ToString() : null), (mlt_DisBes.Text.Trim() != "" ? mlt_DisBes.Value.ToString() : null), SaleRow["Column03"].ToString(), null, null, "تخفیف حجمی گروه مشتری- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), 0, Convert.ToDouble(SaleRow["Column29"].ToString()), 0, -1);
                    //}
                    ////تخفیف ویژه گروه مشتری
                    //if (Convert.ToDouble(SaleRow["Column30"].ToString()) > 0)
                    //{
                    //    //********Bed
                    //    SourceTable.Rows.Add(93, (mlt_DisBed.Text.Trim() != "" ? mlt_DisBed.Value.ToString() : null), (mlt_DisBed.Text.Trim() != "" ? mlt_DisBed.Value.ToString() : null), null, null, null, "تخفیف ویژه گروه مشتری- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), Convert.ToDouble(SaleRow["Column30"].ToString()), 0, 0, -1);
                    //    //*********Bes
                    //    SourceTable.Rows.Add(93, (mlt_DisBes.Text.Trim() != "" ? mlt_DisBes.Value.ToString() : null), (mlt_DisBes.Text.Trim() != "" ? mlt_DisBes.Value.ToString() : null), SaleRow["Column03"].ToString(), null, null, "تخفیف ویژه گروه مشتری- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), 0, Convert.ToDouble(SaleRow["Column30"].ToString()), 0, -1);
                    //}
                    ////تخفیف ویژه مشتری
                    //if (Convert.ToDouble(SaleRow["Column31"].ToString()) > 0)
                    //{
                    //    //********Bed
                    //    SourceTable.Rows.Add(93, (mlt_DisBed.Text.Trim() != "" ? mlt_DisBed.Value.ToString() : null), (mlt_DisBed.Text.Trim() != "" ? mlt_DisBed.Value.ToString() : null), null, null, null, "تخفیف ویژه مشتری- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), Convert.ToDouble(SaleRow["Column31"].ToString()), 0, 0, -1);
                    //    //*********Bes
                    //    SourceTable.Rows.Add(93, (mlt_DisBes.Text.Trim() != "" ? mlt_DisBes.Value.ToString() : null), (mlt_DisBes.Text.Trim() != "" ? mlt_DisBes.Value.ToString() : null), SaleRow["Column03"].ToString(), null, null, "تخفیف ویژه مشتری- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), 0, Convert.ToDouble(SaleRow["Column31"].ToString()), 0, -1);
                    //}
                    ...
                    //if (uiTab3.Enabled)
                    //{
                    //    int HavaleID = int.Parse(clDoc.ExScalar(ConSale.ConnectionString, "Table_070_AmaniFactor", "Column09", "ColumnId", SaleRow["ColumnId"].ToString()));
                    ...
                    //                {
                    //                    //********Bed
                    //                    SourceTable.Rows.Add(26, (mlt_ValueBed.Text.Trim() != "" ? mlt_ValueBed.Value.ToString() : null), (mlt_ValueBed.Text.Trim() != "" ? mlt_ValueBed.Value.ToString() : null), null, null, Convert.ToInt16(row["column14"]), "بهای تمام شده- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), Convert.ToDouble(row["Column16"]), 0, 0, -1, 1);
                    //                    //*********Bes
                    //                    SourceTable.Rows.Add(26, (mlt_ValueBes.Text.Trim() != "" ? mlt_ValueBes.Value.ToString() : null), (mlt_ValueBes.Text.Trim() != "" ? mlt_ValueBes.Value.ToString() : null), null, null, Convert.ToInt16(row["column14"]), "بهای تمام شده- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), 0, Convert.ToDouble(row["Column16"]), 0, -1, 0);
                    //                }
                    //                else
                    //                {
                    //                    //********Bed
                    //                    SourceTable.Rows.Add(26, (mlt_ValueBed.Text.Trim() != "" ? mlt_ValueBed.Value.ToString() : null), (mlt_ValueBed.Text.Trim() != "" ? mlt_ValueBed.Value.ToString() : null), null, null, null, "بهای تمام شده- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), Convert.ToDouble(row["Column16"]), 0, 0, -1, 1);
                    //                    //*********Bes
                    //                    SourceTable.Rows.Add(26, (mlt_ValueBes.Text.Trim() != "" ? mlt_ValueBes.Value.ToString() : null), (mlt_ValueBes.Text.Trim() != "" ? mlt_ValueBes.Value.ToString() : null), null, null, null, "بهای تمام شده- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), 0, Convert.ToDouble(row["Column16"]), 0, -1, 0);
                    //                }
                    //            }
                    //            else
                    //            {
                    ...
                    //        newDraft = true;
                    //        DataTable baha = new DataTable();
                    //        Adapter = new SqlDataAdapter("SELECT column22 as column14,ISNULL(SUM(column20),0) as Column16  from Table_075_Child_AmaniFactor Where Column01=" + SaleRow["columnid"].ToString() + " Group by column22 ", ConSale);
                    //        Adapter.Fill(baha);
                    //        foreach (DataRow row in baha.Rows)
                    //        {
                    ...
                    //            {
                    //                //********Bed
                    //                SourceTable.Rows.Add(26, (mlt_ValueBed.Text.Trim() != "" ? mlt_ValueBed.Value.ToString() : null), (mlt_ValueBed.Text.Trim() != "" ? mlt_ValueBed.Value.ToString() : null), null, null, Convert.ToInt16(row["column14"]), "بهای تمام شده- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), 0, 0, 0, -1, 1);
                    //                //*********Bes
                    //                SourceTable.Rows.Add(26, (mlt_ValueBes.Text.Trim() != "" ? mlt_ValueBes.Value.ToString() : null), (mlt_ValueBes.Text.Trim() != "" ? mlt_ValueBes.Value.ToString() : null), null, null, Convert.ToInt16(row["column14"]), "بهای تمام شده- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), 0, 0, 0, -1, 0);
                    //            }
                    //            else
                    //            {
                    //                //********Bed
                    //                SourceTable.Rows.Add(26, (mlt_ValueBed.Text.Trim() != "" ? mlt_ValueBed.Value.ToString() : null), (mlt_ValueBed.Text.Trim() != "" ? mlt_ValueBed.Value.ToString() : null), null, null, null, "بهای تمام شده- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), 0, 0, 0, -1, 1);
                    //                //*********Bes
                    //                SourceTable.Rows.Add(26, (mlt_ValueBes.Text.Trim() != "" ? mlt_ValueBes.Value.ToString() : null), (mlt_ValueBes.Text.Trim() != "" ? mlt_ValueBes.Value.ToString() : null), null, null, null, "بهای تمام شده- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), 0, 0, 0, -1, 0);
                    //            }
                    //        }
                    //    }
                ...
                {
                    Adapter = new SqlDataAdapter(@" SELECT Column44 FROM  Table_070_AmaniFactor
                    ...
                    if (Convert.ToDouble(SaleRow["Column34"].ToString()) != 0 && !chk_Net.Checked)
                    {
                        ...
                        DataTable ezafeTable = clDoc.ReturnTable(ConSale.ConnectionString,
                   "Select SUM(column19) as ezafe  from Table_075_Child_AmaniFactor where column01=" + SaleRow["ColumnId"].ToString() + "   ");
                        foreach (DataRow d in ezafeTable.Rows)
                        {
                            if (Convert.ToDouble(d["ezafe"].ToString()) != 0)
                            {
                    ...
                    {
                        DataTable takhfifTable = clDoc.ReturnTable(ConSale.ConnectionString,
                            "Select SUM(column17) as takhfif from Table_075_Child_AmaniFactor where column01=" + SaleRow["ColumnId"].ToString() + " ");
                        ...
                        foreach (DataRow h in takhfifTable.Rows)
                        {
                            ...
                            {
                                //********Bed
                                SourceTable.Rows.Add(93, (mlt_LinDisBed.Text.Trim() != "" ? mlt_LinDisBed.Value.ToString() : null), (mlt_LinDisBed.Text.Trim() != "" ? mlt_LinDisBed.Value.ToString() : null), null, null, ((Project.Rows.Count > 0 && Project.Rows[0]["Column44"] != DBNull.Value && Project.Rows[0]["Column44"] != null && !string.IsNullOrWhiteSpace(Project.Rows[0]["Column44"].ToString())) ? Project.Rows[0]["Column44"] : null), "تخفیف خطی فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), Convert.ToDouble(h["takhfif"].ToString()), 0, 0, -1);
                                //*********Bes
                                SourceTable.Rows.Add(93, (mlt_LinDisBes.Text.Trim() != "" ? mlt_LinDisBes.Value.ToString() : null), (mlt_LinDisBes.Text.Trim() != "" ? mlt_LinDisBes.Value.ToString() : null), SaleRow["Column03"].ToString(), null,
                    ...
                    //{
                    //    //********Bed
                    //    SourceTable.Rows.Add(93, (mlt_DisBed.Text.Trim() != "" ? mlt_DisBed.Value.ToString() : null), (mlt_DisBed.Text.Trim() != "" ? mlt_DisBed.Value.ToString() : null), null, null, ((Project.Rows.Count > 0 && Project.Rows[0]["Column44"] != DBNull.Value && Project.Rows[0]["Column44"] != null && !string.IsNullOrWhiteSpace(Project.Rows[0]["Column44"].ToString())) ? Project.Rows[0]["Column44"] : null), "تخفیف حجمی گروه مشتری- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), Convert.ToDouble(SaleRow["Column29"].ToString()), 0, 0, -1);
                    //    //*********Bes
                    //    SourceTable.Rows.Add(93, (mlt_DisBes.Text.Trim() != "" ? mlt_DisBes.Value.ToString() : null), (mlt_DisBes.Text.Trim() != "" ? mlt_DisBes.Value.ToString() : null), SaleRow["Column03"].ToString(), null, ((Project.Rows.Count > 0 && Project.Rows[0]["Column44"] != DBNull.Value && Project.Rows[0]["Column44"] != null && !string.IsNullOrWhiteSpace(Project.Rows[0]["Column44"].ToString())) ? Project.Rows[0]["Column44"] : null), "تخفیف حجمی گروه مشتری- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), 0, Convert.ToDouble(SaleRow["Column29"].ToString()), 0, -1);
                    //}
                    ////تخفیف ویژه گروه مشتری
                    //if (Convert.ToDouble(SaleRow["Column30"].ToString()) > 0)
                    //{
                    //    //********Bed
                    //    SourceTable.Rows.Add(93, (mlt_DisBed.Text.Trim() != "" ? mlt_DisBed.Value.ToString() : null), (mlt_DisBed.Text.Trim() != "" ? mlt_DisBed.Value.ToString() : null), null, null, ((Project.Rows.Count > 0 && Project.Rows[0]["Column44"] != DBNull.Value && Project.Rows[0]["Column44"] != null && !string.IsNullOrWhiteSpace(Project.Rows[0]["Column44"].ToString())) ? Project.Rows[0]["Column44"] : null), "تخفیف ویژه گروه مشتری- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), Convert.ToDouble(SaleRow["Column30"].ToString()), 0, 0, -1);
                    //    //*********Bes
                    //    SourceTable.Rows.Add(93, (mlt_DisBes.Text.Trim() != "" ? mlt_DisBes.Value.ToString() : null), (mlt_DisBes.Text.Trim() != "" ? mlt_DisBes.Value.ToString() : null), SaleRow["Column03"].ToString(), null, ((Project.Rows.Count > 0 && Project.Rows[0]["Column44"] != DBNull.Value && Project.Rows[0]["Column44"] != null && !string.IsNullOrWhiteSpace(Project.Rows[0]["Column44"].ToString())) ? Project.Rows[0]["Column44"] : null), "تخفیف ویژه گروه مشتری- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), 0, Convert.ToDouble(SaleRow["Column30"].ToString()), 0, -1);
                    //}
                    ////تخفیف ویژه مشتری
                    //if (Convert.ToDouble(SaleRow["Column31"].ToString()) > 0)
                    //{
                    //    //********Bed
                    //    SourceTable.Rows.Add(93, (mlt_DisBed.Text.Trim() != "" ? mlt_DisBed.Value.ToString() : null), (mlt_DisBed.Text.Trim() != "" ? mlt_DisBed.Value.ToString() : null), null, null, ((Project.Rows.Count > 0 && Project.Rows[0]["Column44"] != DBNull.Value && Project.Rows[0]["Column44"] != null && !string.IsNullOrWhiteSpace(Project.Rows[0]["Column44"].ToString())) ? Project.Rows[0]["Column44"] : null), "تخفیف ویژه مشتری- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), Convert.ToDouble(SaleRow["Column31"].ToString()), 0, 0, -1);
                    //    //*********Bes
                    //    SourceTable.Rows.Add(93, (mlt_DisBes.Text.Trim() != "" ? mlt_DisBes.Value.ToString() : null), (mlt_DisBes.Text.Trim() != "" ? mlt_DisBes.Value.ToString() : null), SaleRow["Column03"].ToString(), null, ((Project.Rows.Count > 0 && Project.Rows[0]["Column44"] != DBNull.Value && Project.Rows[0]["Column44"] != null && !string.IsNullOrWhiteSpace(Project.Rows[0]["Column44"].ToString())) ? Project.Rows[0]["Column44"] : null), "تخفیف ویژه مشتری- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), 0, Convert.ToDouble(SaleRow["Column31"].ToString()), 0, -1);
                    //}
                    ...
                    //if (uiTab3.Enabled)
                    //{
                    //    int HavaleID = int.Parse(clDoc.ExScalar(ConSale.ConnectionString, "Table_070_AmaniFactor", "Column56", "ColumnId", SaleRow["ColumnId"].ToString()));
                    //    double TotalValue = double.Parse(clDoc.ExScalar(ConWare.ConnectionString, "Table_008_Child_PwhrsDraft", "ISNULL(SUM(Column16),0)", "Column01", HavaleID.ToString()));
                    ...
                    //                {
                    //                    //********Bed
                    //                    SourceTable.Rows.Add(26, (mlt_ValueBed.Text.Trim() != "" ? mlt_ValueBed.Value.ToString() : null), (mlt_ValueBed.Text.Trim() != "" ? mlt_ValueBed.Value.ToString() : null), null, null, ((Project.Rows.Count > 0 && Project.Rows[0]["Column44"] != DBNull.Value && Project.Rows[0]["Column44"] != null && !string.IsNullOrWhiteSpace(Project.Rows[0]["Column44"].ToString())) ? Project.Rows[0]["Column44"] : null), "بهای تمام شده- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), Convert.ToDouble(row["Column16"]), 0, 0, -1, 1);
                    //                    //*********Bes
                    //                    SourceTable.Rows.Add(26, (mlt_ValueBes.Text.Trim() != "" ? mlt_ValueBes.Value.ToString() : null), (mlt_ValueBes.Text.Trim() != "" ? mlt_ValueBes.Value.ToString() : null), null, null, ((Project.Rows.Count > 0 && Project.Rows[0]["Column44"] != DBNull.Value && Project.Rows[0]["Column44"] != null && !string.IsNullOrWhiteSpace(Project.Rows[0]["Column44"].ToString())) ? Project.Rows[0]["Column44"] : null), "بهای تمام شده- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), 0, Convert.ToDouble(row["Column16"]), 0, -1, 0);
                    //                }
                    //            }
                    //            else
                    //            {
                    ...
                    //        newDraft = true;
                    //        DataTable baha = new DataTable();
                    //        Adapter = new SqlDataAdapter("SELECT ISNULL(SUM(column20),0) as Column16  from Table_075_Child_AmaniFactor Where Column01=" + SaleRow["columnid"].ToString() + "  ", ConSale);
                    //        Adapter.Fill(baha);
                    //        foreach (DataRow row in baha.Rows)
                    //        {
                    //            //********Bed
                    //            SourceTable.Rows.Add(26, (mlt_ValueBed.Text.Trim() != "" ? mlt_ValueBed.Value.ToString() : null), (mlt_ValueBed.Text.Trim() != "" ? mlt_ValueBed.Value.ToString() : null), null, null, ((Project.Rows.Count > 0 && Project.Rows[0]["Column44"] != DBNull.Value && Project.Rows[0]["Column44"] != null && !string.IsNullOrWhiteSpace(Project.Rows[0]["Column44"].ToString())) ? Project.Rows[0]["Column44"] : null), "بهای تمام شده- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), 0, 0, 0, -1, 1);
                    //            //*********Bes
                    //            SourceTable.Rows.Add(26, (mlt_ValueBes.Text.Trim() != "" ? mlt_ValueBes.Value.ToString() : null), (mlt_ValueBes.Text.Trim() != "" ? mlt_ValueBes.Value.ToString() : null), null, null, ((Project.Rows.Count > 0 && Project.Rows[0]["Column44"] != DBNull.Value && Project.Rows[0]["Column44"] != null && !string.IsNullOrWhiteSpace(Project.Rows[0]["Column44"].ToString())) ? Project.Rows[0]["Column44"] : null), "بهای تمام شده- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), 0, 0, 0, -1, 0);
            ...
            else
            {
                ...
                if (Convert.ToDouble(SaleRow["Column34"].ToString()) != 0 && !chk_Net.Checked)
                {
                    ...
                    SourceTable.Rows.Add(93, (mlt_LinAddBed.Text.Trim() != "" ? mlt_LinAddBed.Value.ToString() : null),
                        (mlt_LinAddBed.Text.Trim() != "" ? mlt_LinAddBed.Value.ToString() : null), SaleRow["Column03"].ToString(),
                        null, null, (Convert.ToDouble(SaleRow["Column34"].ToString()) > 0 ? "اضافه خطی فاکتور فروش امانی ش " : "تخفیف خطی2 فاکتور فروش امانی ش ") +
                        SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(),
                ...
                if (Convert.ToDouble(SaleRow["Column35"].ToString()) > 0 && !chk_Net.Checked)
                {
                    ...
                    //********Bed
                    SourceTable.Rows.Add(93, (mlt_LinDisBed.Text.Trim() != "" ? mlt_LinDisBed.Value.ToString() : null), (mlt_LinDisBed.Text.Trim() != "" ? mlt_LinDisBed.Value.ToString() : null), null, null, null, "تخفیف خطی فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), Convert.ToDouble(SaleRow["Column35"].ToString()), 0, 0, -1);
                    //*********Bes
                    SourceTable.Rows.Add(93, (mlt_LinDisBes.Text.Trim() != "" ? mlt_LinDisBes.Value.ToString() : null), (mlt_LinDisBes.Text.Trim() != "" ? mlt_LinDisBes.Value.ToString() : null), SaleRow["Column03"].ToString(), null, null, "تخفیف خطی فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), 0, Convert.ToDouble(SaleRow["Column35"].ToString()), 0, -1);
                ...
                //    {
                //        //********Bed
                //        SourceTable.Rows.Add(26, (mlt_ValueBed.Text.Trim() != "" ? mlt_ValueBed.Value.ToString() : null), (mlt_ValueBed.Text.Trim() != "" ? mlt_ValueBed.Value.ToString() : null), null, null, null, "بهای تمام شده- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), TotalValue, 0, 0, -1, 1);
                //        //*********Bes
                //        SourceTable.Rows.Add(26, (mlt_ValueBes.Text.Trim() != "" ? mlt_ValueBes.Value.ToString() : null), (mlt_ValueBes.Text.Trim() != "" ? mlt_ValueBes.Value.ToString() : null), null, null, null, "بهای تمام شده- فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString(), 0, TotalValue, 0, -1, 0);
                //    }
                //    else
                //    {
                //        //********Bed
            ...
            try
            {
                ...
                foreach (DataRow item in _1Table.Rows)
                {
                    ...
                    if (SourceTable.DefaultView.ToTable().Rows.Count > 0)
                    {
                        ...
                        {
                            Description = " فاکتور فروش امانی ش " + SaleRow["Column01"].ToString() + " به تاریخ " + SaleRow["Column02"].ToString();
                        ...
                        if (Bed - Bes != 0 && item["Type"].ToString() == "93")
        ...
        private void bt_ExportDoc_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (DialogResult.Yes == MessageBox.Show(Message, "", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1, MessageBoxOptions.RightAlign))
                {
                    ...
                    if (uiTab2.Enabled)
                    {
                        if (clDoc.OperationalColumnValue("Table_070_AmaniFactor", "Column56", _SaleID.ToString()) != 0)
                            throw new Exception("برای این فاکتور حواله و رسید انبار صادر شده است");
                        else
                            ExportDraft();
                    }

                    if (clDoc.OperationalColumnValue("Table_070_AmaniFactor", "Column57", _SaleID.ToString()) != 0)
                ...
                VALUES((Select Isnull((Select Max(Column00) from Table_060_SanadHead),0))+1,'" + faDatePicker1.Text + "',2,0,'" + txt_Cover.Text + "','" + Class_BasicOperation._UserName +
                    ...
                    {
                        gridEX1.UpdateData();
                        CommandTxt += @" set @ResidID=(select Column55 from " + ConSale.Database + ".dbo.Table_070_AmaniFactor where  ColumnId=" + SaleRow["ColumnId"].ToString() + ")";
                        CommandTxt += @" set @HavaleID=(select Column56 from " + ConSale.Database + ".dbo.Table_070_AmaniFactor where  ColumnId=" + SaleRow["ColumnId"].ToString() + ")";
                        ...
                        foreach (GridEXRow item in gridEX1.GetRows())
                        {
                            ...
                            if (item.Cells["Type"].Value.ToString() == "93" && (Convert.ToDouble(item.Cells["Column11"].Value.ToString()) > 0 || Convert.ToDouble(item.Cells["Column12"].Value.ToString()) > 0))
                            {
              ...
              ,[Column06]      ,[Column07]      ,[Column08]      ,[Column09]      ,[Column10]      ,[Column11]    ,[Column12]      ,[Column13]      ,[Column14]      ,[Column15]      ,[Column16]      ,[Column17] ,[Column18]      ,[Column19]      ,[Column20]      ,[Column21]      ,[Column22]) 
                   ...
                   " + "'" + item.Cells["Column10"].Text.Trim() + "'," + (item.Cells["Column12"].Text == "0" ? Convert.ToInt64(Convert.ToDouble(item.Cells["Column11"].Value.ToString())) : 0) + @",
                        " + (item.Cells["Column11"].Text == "0" ? Convert.ToInt64(Convert.ToDouble(item.Cells["Column12"].Value.ToString())) : 0) + ",0,0,-1,93," + int.Parse(SaleRow["ColumnId"].ToString()) + ",'" + Class_BasicOperation._UserName + "',getdate(),'" +
              ...
              ,[Column06]      ,[Column07]      ,[Column08]      ,[Column09]      ,[Column10]      ,[Column11]    ,[Column12]      ,[Column13]      ,[Column14]      ,[Column15]      ,[Column16]      ,[Column17] ,[Column18]      ,[Column19]      ,[Column20]      ,[Column21]      ,[Column22]) 
                 ...
                 Class_BasicOperation._UserName + "',getdate(),0);  ";
                            ...
                            else if (item.Cells["Type"].Value.ToString() == "26" && (Convert.ToDouble(item.Cells["Column11"].Value.ToString()) == 0 && Convert.ToDouble(item.Cells["Column12"].Value.ToString()) == 0))
                            {
                                ...
                                SqlDataAdapter Adapter = new SqlDataAdapter(@" SELECT * FROM  [Table_075_Child_AmaniFactor]
                                                    WHERE column01=  " + SaleRow["ColumnId"].ToString() + " AND [column22] is NOT NULL", ConSale);
                                DataTable Project = new DataTable();
            ...
            Class_BasicOperation._UserName + "',getdate(),0); set @value = 0 end ";
                        ...
                        CommandTxt += @"Update " + ConSale.Database + ".dbo.Table_070_AmaniFactor set Column57= @Key,Column56= @HavaleID,Column55=@ResidID,Column15='" + Class_BasicOperation._UserName + "',Column16=getdate()  where ColumnId =" + int.Parse(SaleRow["ColumnId"].ToString());
           ...
           ,[Column34]
            ,[Column35]) VALUES(@Key," + item["Column02"].ToString() + "," +
                    ...
                    using (SqlConnection Con = new SqlConnection(Properties.Settings.Default.WHRS))
                    {
                        ...
                        wareRecipt + "," + mlt_FunctionRecipt.Value + ",NULL,'" + "رسید صادره بابت انتقالی بین انبارهای مربوط به فاکتور امانی شماره" +
                                                                    ...
                                                                    SET @unitvalue =(CASE WHEN @share>0 then (
                                                                            ISNULL(
                                                                                (
                                                                                    ...
                                                                                    FROM   Table_075_Child_AmaniFactor tcbf
        ...
        private string CerateSharh(double TotalValue, double TotalAmount, double TotalNetPrice)
        {
            ...
            try
            {
                if (Convert.ToBoolean(setting.Rows[3]["Column02"]))
                    Sharh = "فاکتور فروش امانی ش " + SaleRow["Column01"].ToString();
                ...
                //    {
                //        ConWare.Open();
                //        string CommandText = @"SELECT     Column02 From table_004_CommodityAndIngredients WHERE ColumnId=(select top 1 column02 from " + ConSale.Database + ".dbo.Table_075_Child_AmaniFactor where column01 =" + SaleRow["columnid"] + ")   ";
