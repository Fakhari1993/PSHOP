...
{
    public partial class Frm_002_StoreFaktorPrint : Form
    {
        ...
        bool Isadmin = false;
        Int16 projectId;
        public Frm_002_StoreFaktorPrint()
        {
            InitializeComponent();
                ...
                )
            {
                ...
                if (UserScope.CheckScope(Class_BasicOperation._UserName, "Column11", 128))
                {
                    ...
                    _05_Sale.Reports.Form_SaleFactorPrint1 frm =
                       new Reports.Form_SaleFactorPrint1(Convert.ToInt32(mlt_Customer.Value), faDatePicker1.Text, faDatePicker2.Text);
                    frm.ShowDialog();
