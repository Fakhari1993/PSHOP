...
{
    public partial class Form05_CancelOrdersDialog : Form
    {
        public string Date = null;
        public string Cause = null;
        bool _BackSpace = false;

        public Form05_CancelOrdersDialog()
        {
            InitializeComponent();
        }
        ...
        {
            if (faDatePicker1.Text.Trim() != "" && txt_Cause.Text.Trim() != "")
            {
                Cause = txt_Cause.Text.Trim();
