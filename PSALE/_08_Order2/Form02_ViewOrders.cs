...
namespace PSHOP._08_Order2
{
    public partial class Form02_ViewOrders : Form
    {
        ...
        private void Form01_ViewOrders_Load(object sender, EventArgs e)
        {
            ...
            gridEX1.DropDowns["DraftType"].DataSource = clDoc.ReturnTable(Properties.Settings.Default.WHRS, "Select * from table_005_PwhrsOperation where Column16=1");

            gridEX1.DropDowns["SaleBoss"].DataSource = clDoc.ReturnTable(ConBase.ConnectionString, @"SELECT dbo.Table_045_PersonInfo.ColumnId AS id,
            ...
            Adapter.Fill(dt );
            gridEX2.DropDowns["Project"].DataSource = dt;

            gridEX2.DropDowns[1].SetDataBinding(clGood.GoodInfo(), "");
            try
            {
                gridEX2.DropDowns["MainGroup"].DataSource = clDoc.ReturnTable(ConWare.ConnectionString, @"SELECT tcai.columnid,tmg.column02 From  table_004_CommodityAndIngredients tcai join  table_002_MainGroup tmg   ON  tmg.columnid = tcai.column03");
            }
            catch
            {
            }
            gridEX2.DropDowns["SubGroup"].DataSource = clDoc.ReturnTable(this.ConWare.ConnectionString, @"SELECT tcai.columnid,tsg.column03 From table_004_CommodityAndIngredients tcai   JOIN dbo.table_003_SubsidiaryGroup tsg
        ...
        private void mnu_Cancel_Click(object sender, EventArgs e)
        {
            try
            {
                if (gridEX1.RowCount > 0)
                {
                    ...
                    if (gridEX1.GetRow().Cells["Column33"].Value.ToString() == "True")
                        throw new Exception("برای سفارش حواله صادر شده است");
                    ...
                    {
                        Form05_CancelOrdersDialog frm = new Form05_CancelOrdersDialog();
...
//                    //                         AND (Table_005_OrderHeader.column13 = 0)   AND   
                ...
                if (WhereType == "Exit")
                {
                    CommandText =
                                ...
                                @"
                                                            ...
                                                            SELECT *
                                                            FROM   (
                                                                       SELECT dbo.Table_005_OrderHeader.column01,
                                                                              dbo.Table_005_OrderHeader.column02,
                                                                              dbo.Table_005_OrderHeader.column03,
                                                                              dbo.Table_005_OrderHeader.column04,
                                                                              dbo.Table_005_OrderHeader.column05,
                                                                              dbo.Table_005_OrderHeader.column06,
                                                                              dbo.Table_005_OrderHeader.column07,
                                                                              dbo.Table_005_OrderHeader.column08,
                                                                              dbo.Table_005_OrderHeader.column09,
                                                                              dbo.Table_005_OrderHeader.column10,
                                                                              dbo.Table_005_OrderHeader.column11,
                                                                              dbo.Table_005_OrderHeader.column12,
                                                                              dbo.Table_005_OrderHeader.column13,
                                                                              dbo.Table_005_OrderHeader.column14,
                                                                              dbo.Table_005_OrderHeader.column15,
                                                                              dbo.Table_005_OrderHeader.column16,
                                                                              dbo.Table_005_OrderHeader.column17,
                                                                              dbo.Table_005_OrderHeader.column18,
                                                                              dbo.Table_005_OrderHeader.column19,
                                                                              dbo.Table_005_OrderHeader.column20,
                                                                              dbo.Table_005_OrderHeader.column21,
                                                                              dbo.Table_005_OrderHeader.column22,
                                                                              dbo.Table_005_OrderHeader.column23,
                                                                              dbo.Table_005_OrderHeader.column24,
                                                                              dbo.Table_005_OrderHeader.column25,
                                                                              dbo.Table_005_OrderHeader.column26,
                                                                              dbo.Table_005_OrderHeader.column27,
                                                                              dbo.Table_005_OrderHeader.column28,
                                                                              dbo.Table_005_OrderHeader.column29,
                                                                              dbo.Table_005_OrderHeader.column30,
                                                                              dbo.Table_005_OrderHeader.column31,
                                                                              dbo.Table_005_OrderHeader.column32,
                                                                              dbo.Table_005_OrderHeader.column33,
                                                                              dbo.Table_005_OrderHeader.column34,
                                                                              dbo.Table_005_OrderHeader.column35,
                                                                              dbo.Table_005_OrderHeader.column36,
                                                                              dbo.Table_005_OrderHeader.column37,
                                                                              dbo.Table_005_OrderHeader.column38,
                                                                              dbo.Table_005_OrderHeader.column39,
                                                                              dbo.Table_005_OrderHeader.column40,
                                                                              dbo.Table_005_OrderHeader.column41,
                                                                              dbo.Table_005_OrderHeader.columnid,
                                                                              derivedtbl_1.TotalBox,
                                                                              derivedtbl_1.TotalExitBox,
                                                                              derivedtbl_1.Difference,
                                                                              (
                                                                                  CASE 
                                                                                       WHEN (
                                                                                                SELECT COUNT(*)
                                                                                                FROM   Table_006_OrderDetails
                                                                                                WHERE  column01 = Table_005_OrderHeader.columnid
                                                                                                       AND column17 != column06
                                                                                                       AND column17 < column06
                                                                                            ) > 0 THEN 1
                                                                                       ELSE 0
                                                                                  END
                                                                       ...
                                                                       FROM   dbo.Table_005_OrderHeader
                                                                              INNER JOIN (
                                                                                       SELECT column01,
                                                                                              SUM(column04) AS TotalBox,
                                                                                              SUM(column16) AS TotalExitBox,
                                                                                              SUM(column04) - SUM(column16) AS DIFFERENCE
                                                                                       FROM   dbo.Table_006_OrderDetails
                                                                                       GROUP BY
                                                                                              column01
                                                                                   ) AS derivedtbl_1
                                                                                   ON  dbo.Table_005_OrderHeader.columnid = derivedtbl_1.column01
                                                                       WHERE  (
                                                                                  Table_005_OrderHeader.column02 BETWEEN '" + Date1 + @"' AND 
                                                                                  '" + Date2 + @"'
                                                                              )
                                                                   ) AS h
                                                            WHERE  h.ok = 1 ";
