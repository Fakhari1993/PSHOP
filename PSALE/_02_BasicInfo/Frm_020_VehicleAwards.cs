...
{
    public partial class Frm_020_VehicleAwards : Form
    {
        bool _del;
        ...
        public Frm_020_VehicleAwards(bool del)
        {
            _del = del;
            InitializeComponent();
        }
        ...
        private void Frm_005_Javayez_Load(object sender, EventArgs e)
        {
            ...
            this.table_115_VehicleTypeTableAdapter.Fill(
                this.dataSet_05_Awards.Table_115_VehicleType);

            this.table_050_VehicleAwardsTableAdapter.Fill(
                this.dataSet_05_Awards.Table_050_VehicleAwards);
            ...
            gridEX1.DropDowns[2].SetDataBinding(dataSet_05_Awards, "Table_115_VehicleType");
        ...
        private void bt_Save_Click(object sender, EventArgs e)
        {
            ...
            {
                this.Validate();
                this.table_050_VehicleAwardsBindingSource.EndEdit();
                this.table_050_VehicleAwardsTableAdapter.Update(dataSet_05_Awards.Table_050_VehicleAwards);
        ...
        private void bt_Del_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    this.table_050_VehicleAwardsBindingSource.RemoveCurrent();
        ...
        private void gridEX1_CellUpdated(object sender, Janus.Windows.GridEX.ColumnActionEventArgs e)
        {
            if (gridEX1.Row == -1)
            {
                ...
                if (gridEX1.Col != gridEX1.RootTable.Columns["column04"].Index)
                    gridEX1.SetValue("column04", _Vehcile);
                else
                    _Vehcile = Convert.ToInt16(gridEX1.GetValue("column04"));

                if (gridEX1.Col != gridEX1.RootTable.Columns["column05"].Index)
                    gridEX1.SetValue("column05", _Kala);
                else
                    _Kala = Convert.ToInt32(gridEX1.GetValue("column05"));

                if (gridEX1.Col != gridEX1.RootTable.Columns["column06"].Index)
                    gridEX1.SetValue("column06", _QtyAward);
                else
                    _QtyAward = Convert.ToDouble(gridEX1.GetValue("column06"));
            }
        ...
        private void gridEX1_AddingRecord(object sender, CancelEventArgs e)
        {
            ...
            gridEX1.SetValue("column08", _serverdatetime);
            gridEX1.SetValue("column10", _serverdatetime);
        }
