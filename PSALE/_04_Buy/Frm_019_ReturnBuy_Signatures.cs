...
{
    public partial class Frm_019_ReturnBuy_Signatures : Form
    {
        BindingSource T125BindingSource = new BindingSource();
        SqlConnection ConBase = new SqlConnection(Properties.Settings.Default.BASE);

        public Frm_019_ReturnBuy_Signatures()
        {
            InitializeComponent();
        }
        ...
        {
            SqlDataAdapter Adapter = new SqlDataAdapter("Select * from Table_125_Signature where ColumnId=11", ConBase);
        ...
        private void bt_Save_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection Con = new SqlConnection(Properties.Settings.Default.BASE))
            {
                ...
                SqlCommand Update = new SqlCommand("UPDATE Table_125_Signature Set Column01=" +
                   ...
                   txt_Name4.Text.Trim() + " where ColumnId=11", Con);
