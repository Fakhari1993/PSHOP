...
namespace PSHOP._06_Reports._01_Orders
{
    ...
    public partial class Form03_OrderGoodsWay : Form
    {
        ...
        private void bt_Search_Click(object sender, EventArgs e)
        {
            ...
            if (faDatePickerStrip1.FADatePicker.SelectedDateTime.HasValue && faDatePickerStrip2.FADatePicker.SelectedDateTime.HasValue && mlt_Good.Text.Trim()!="")
            {
                ...
                SqlDataAdapter Adapter = new SqlDataAdapter(@"SELECT     TOP (100) PERCENT dbo.Table_006_OrderDetails.column02,
                    ...
                    GROUP BY dbo.Table_006_OrderDetails.column02, dbo.Table_005_OrderHeader.column02", ConSale);
                    Adapter.SelectCommand.CommandText = string.Format(Adapter.SelectCommand.CommandText, faDatePickerStrip1.FADatePicker.Text, faDatePickerStrip2.FADatePicker.Text,mlt_Good.Value.ToString());
        ...
        private void bt_ViewChart_Click(object sender, EventArgs e)
        {
            ...
            if (PrintTable.Rows.Count > 0)
            {
                ...
                Title.Text = "نمودار روند سفارشات محصول " + mlt_Good.Text + " از تاریخ " + Date1 + " تا تاریخ " + Date2 ;
