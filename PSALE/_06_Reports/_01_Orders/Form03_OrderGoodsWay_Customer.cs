...
namespace PSHOP._06_Reports._01_Orders
{
    ...
    public partial class Form03_OrderGoodsWay_Customer : Form
    {
        ...
        public Form03_OrderGoodsWay_Customer()
        {
            InitializeComponent();
        }
        private void Form03_OrderGoodsWay_Load(object sender, EventArgs e)
        {
            ...
            string SelectCommand = @"SELECT     dbo.Table_045_PersonInfo.ColumnId AS id, dbo.Table_045_PersonInfo.Column01 AS code, dbo.Table_045_PersonInfo.Column02 AS name, 
            ...
            mlt_Customer.DataSource = clDoc.ReturnTable(Properties.Settings.Default.BASE, SelectCommand);
        ...
        private void bt_Search_Click(object sender, EventArgs e)
        {
            ...
            if (faDatePickerStrip1.FADatePicker.SelectedDateTime.HasValue && faDatePickerStrip2.FADatePicker
                .SelectedDateTime.HasValue && mlt_Good.Text.Trim()!="" && mlt_Customer.Text.Trim()!="")
            {
                ...
                SqlDataAdapter Adapter = new SqlDataAdapter(@"SELECT     TOP (100) PERCENT dbo.Table_006_OrderDetails.column02,Table_005_OrderHeader.column03,
                    SUM(dbo.Table_006_OrderDetails.column03)as Pack,SUM(dbo.Table_006_OrderDetails.column04) as Box,
                    SUM(dbo.Table_006_OrderDetails.column05) as Detail,
                    SUM(dbo.Table_006_OrderDetails.column06) AS OrderNumber, 
                    dbo.Table_005_OrderHeader.column02 AS Date,
                     SUM(dbo.Table_006_OrderDetails.column15) as ExitPack,
                      SUM(dbo.Table_006_OrderDetails.column16)as ExitBox,
                       SUM(dbo.Table_006_OrderDetails.column14)as ExitDetail,
                     SUM(dbo.Table_006_OrderDetails.column17) AS ExitNumber
                    ...
                    (dbo.Table_006_OrderDetails.column02 = {2}) AND (dbo.Table_005_OrderHeader.Column03={3})
                    GROUP BY dbo.Table_006_OrderDetails.column02, dbo.Table_005_OrderHeader.column02,Table_005_OrderHeader.column03", ConSale);
                    Adapter.SelectCommand.CommandText = string.Format(Adapter.SelectCommand.CommandText, 
                        Date1, Date2,mlt_Good.Value.ToString(),mlt_Customer.Value.ToString());
        ...
        private void bt_ViewChart_Click(object sender, EventArgs e)
        {
            ...
            if (PrintTable.Rows.Count > 0)
            {
                ...
                Title.Text = "نمودار روند سفارشات محصول " + mlt_Good.Text + " از تاریخ " + Date1 +
                    " تا تاریخ " + Date2+"**نام مشتری:  "+mlt_Customer.Text; 
