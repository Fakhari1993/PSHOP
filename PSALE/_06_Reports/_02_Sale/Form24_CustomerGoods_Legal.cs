...
{
    public partial class Form24_CustomerGoods_Legal : Form
    {
        ...
        public Form24_CustomerGoods_Legal()
        {
            InitializeComponent();
        }
        ...
        private void bt_Search_Click(object sender, EventArgs e)
        {
            if (faDatePickerStrip1.FADatePicker.SelectedDateTime.HasValue && faDatePickerStrip2.FADatePicker.SelectedDateTime.HasValue)
            {
                ...
                string CommandText = null;
                    ...
                    CommandText = @"SELECT     dbo.Table_055_LegalFactors.column03 AS CustomerId, PersonTable.Column01 AS CustomerCode, PersonTable.Column02 AS CustomerName, 
                      ...
                      SUM(dbo.Table_060_Child1_LegalFactors.column04) AS BoxNumber, SUM(dbo.Table_060_Child1_LegalFactors.column05) AS PackNumber, 
                      SUM(dbo.Table_060_Child1_LegalFactors.column06) AS DetailNumber, SUM(dbo.Table_060_Child1_LegalFactors.column07) AS TotalNumber, 
                      SUM(dbo.Table_060_Child1_LegalFactors.column11) AS TotalPrice, 0.000 as TotalPrice2,SUM(dbo.Table_060_Child1_LegalFactors.column17) AS TotalDiscount, 0.000 as TotalDiscount2,
                      SUM(dbo.Table_060_Child1_LegalFactors.column19) AS TotalExtra,0.000 as TotalExtra2,SUM(dbo.Table_060_Child1_LegalFactors.Column20) as NetPrice, 0.000 as NetPrice2,
                     ...
                     GROUP BY dbo.Table_055_LegalFactors.column03, PersonTable.Column01, PersonTable.Column02, dbo.Table_060_Child1_LegalFactors.column02, GoodTable.column01, 
                      ...
                      dbo.Table_055_LegalFactors.column12, dbo.Table_055_LegalFactors.Column41, dbo.Table_055_LegalFactors.Column40";
                ...
                Adapter = new SqlDataAdapter(@"SELECT     TOP (100) PERCENT dbo.Table_060_Child1_LegalFactors.column02 AS GoodId, dbo.Table_055_LegalFactors.column01 AS Number, 
                      dbo.Table_055_LegalFactors.column02 AS Date, dbo.Table_055_LegalFactors.column03 AS CustomerId, dbo.Table_055_LegalFactors.columnid as ID
            FROM         dbo.Table_060_Child1_LegalFactors INNER JOIN
                      dbo.Table_055_LegalFactors ON dbo.Table_060_Child1_LegalFactors.column01 = dbo.Table_055_LegalFactors.columnid
            WHERE     (dbo.Table_055_LegalFactors.column02 BETWEEN '" + Date1 + "' AND '" + Date2 + @"')
            GROUP BY dbo.Table_060_Child1_LegalFactors.column02, dbo.Table_055_LegalFactors.column01, dbo.Table_055_LegalFactors.column02, 
                      dbo.Table_055_LegalFactors.column03, 
                      dbo.Table_055_LegalFactors.columnid
