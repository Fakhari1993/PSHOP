...
{
    public partial class Form28_Legal_Monthly_Value_Good : Form
    {
        SqlConnection ConSale = new SqlConnection(Properties.Settings.Default.SALE);
        SqlConnection ConWare = new SqlConnection(Properties.Settings.Default.WHRS);
        public Form28_Legal_Monthly_Value_Good()
        {
            InitializeComponent();
        }
        ...
        private void Form04_SaleReport_NumericMonthly_Load(object sender, EventArgs e)
        {
            ...
            dbo.Table_060_Child1_LegalFactors.column02 AS GoodID, SUM(dbo.Table_060_Child1_LegalFactors.Column11) AS TotalNumber, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '01' THEN SUM(dbo.Table_060_Child1_LegalFactors.Column11) ELSE 0 END AS Far, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '02' THEN SUM(dbo.Table_060_Child1_LegalFactors.Column11) ELSE 0 END AS Ord, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '03' THEN SUM(dbo.Table_060_Child1_LegalFactors.Column11) ELSE 0 END AS Khord,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '04' THEN SUM(dbo.Table_060_Child1_LegalFactors.Column11) ELSE 0 END AS Tir, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '05' THEN SUM(dbo.Table_060_Child1_LegalFactors.Column11) 
            ELSE 0 END AS Mordad, CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) 
            = '06' THEN SUM(dbo.Table_060_Child1_LegalFactors.Column11) ELSE 0 END AS Shahr, CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 
            2) = '07' THEN SUM(dbo.Table_060_Child1_LegalFactors.Column11) ELSE 0 END AS Mehr, CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 
            2) = '08' THEN SUM(dbo.Table_060_Child1_LegalFactors.Column11) ELSE 0 END AS Aban, CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 
            2) = '09' THEN SUM(dbo.Table_060_Child1_LegalFactors.Column11) ELSE 0 END AS Azar, CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 
            2) = '10' THEN SUM(dbo.Table_060_Child1_LegalFactors.Column11) ELSE 0 END AS Dey, CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 
            2) = '11' THEN SUM(dbo.Table_060_Child1_LegalFactors.Column11) ELSE 0 END AS Bahman, CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02,
            6, 2) = '12' THEN SUM(dbo.Table_060_Child1_LegalFactors.Column11) ELSE 0 END AS Esf
        ...
        private void mnu_PrintTable_Click(object sender, EventArgs e)
        {
            ...
            {
                _06_Reports.Form01_ReportForm frm = new Form01_ReportForm(Table, 14, "***فروش ریالی***", " ");
                frm.ShowDialog();
            }
        }
        ...
        private void gridEX_Accounts_RowDoubleClick(object sender, Janus.Windows.GridEX.RowActionEventArgs e)
        {
            try
            {
                ...
                if (Table.Rows.Count > 0)
                {
                    ...
                    Title.Text = "نمودار ماهیانه میزان فروش ریالی کالای  " + e.Row.Cells["GoodName"].Text;
        ...
        private void mnu_PrintBoth_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Table.Rows.Count > 0)
                {
                    _06_Reports.Form01_ReportForm frm = new Form01_ReportForm(Table, 15, gridEX_Goods.GetRow().Cells["GoodCode"].Text, gridEX_Goods.GetRow().Cells["GoodName"].Text);
                    frm.ShowDialog();
                }
            }
            catch { }
