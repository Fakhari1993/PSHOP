...
{
    public partial class Form08_ReturnSaleReport_Good : Form
    {
        ...
        public Form08_ReturnSaleReport_Good()
        {
            InitializeComponent();
        }
        ...
        private void Form03_SaleReport_Goods_Load(object sender, EventArgs e)
        {
            ...
            string[] Dates = Properties.Settings.Default.ReturnSaleReport_Good.Split('-');
            ...
            gridEX_Goods.DropDowns["project"].SetDataBinding(Goods, "");
        ...
        private void bt_Search_Click(object sender, EventArgs e)
        {
            if (faDatePickerStrip1.FADatePicker.SelectedDateTime.HasValue && faDatePickerStrip2.FADatePicker.SelectedDateTime.HasValue)
            {
                ...
                Date2 = faDatePickerStrip2.FADatePicker.Text;
                    ...
                    this.rpt_ReturnFactor_GoodsTableAdapter.Fill(dataSet_Sale.Rpt_ReturnFactor_Goods, Date1, Date2,chk_Currency.Checked);
                    this.rpt_ReturnFactor_Goods_CustomerTableAdapter.Fill(dataSet_Sale.Rpt_ReturnFactor_Goods_Customer, Date1, Date2,chk_Currency.Checked);
                    this.rpt_ReturnFactor_Goods_FactorsTableAdapter.Fill(dataSet_Sale.Rpt_ReturnFactor_Goods_Factors, Date1, Date2,chk_Currency.Checked);
            }
        }
        ...
        {
            if (faDatePickerStrip1.FADatePicker.SelectedDateTime.HasValue && faDatePickerStrip2.FADatePicker.SelectedDateTime.HasValue)
                Properties.Settings.Default.ReturnSaleReport_Good = faDatePickerStrip1.FADatePicker.Text + "-" + faDatePickerStrip2.FADatePicker.Text;
        ...
        private void mnu_PrintThis_Click(object sender, EventArgs e)
        {
            ...
            foreach (Janus.Windows.GridEX.GridEXRow CustomerRow in gridEX_Customers.GetRows())
            {
                ...
                foreach (Janus.Windows.GridEX.GridEXRow Factor in gridEX_Factors.GetRows())
                {
                    ...
                    New["TotalNumber"] = Convert.ToDouble(gridEX_Goods.GetRow().Cells["TotalNumber"].Value.ToString());
            ...
            {
                _06_Reports.Form01_ReportForm frm = new Form01_ReportForm(Table, 25, "از تاریخ: "+Date1, "تا تاریخ: "+Date2);
                frm.ShowDialog();
            }
        }
