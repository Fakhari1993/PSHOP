...
{
    public partial class Form03_SaleReport_Goods : Form
    {
        ...
        public Form03_SaleReport_Goods()
        {
            InitializeComponent();
        }
        ...
        private void Form03_SaleReport_Goods_Load(object sender, EventArgs e)
        {
            ...
            gridEX_Goods.DropDowns["MainGroup"].DataSource = clDoc.ReturnTable(ConWare.ConnectionString, @"SELECT     dbo.table_004_CommodityAndIngredients.columnid AS GoodId, dbo.table_002_MainGroup.column02 AS MainName
            FROM         dbo.table_004_CommodityAndIngredients INNER JOIN
            dbo.table_002_MainGroup ON dbo.table_004_CommodityAndIngredients.column03 = dbo.table_002_MainGroup.columnid");
            gridEX_Goods.DropDowns["SubGroup"].DataSource = clDoc.ReturnTable(ConWare.ConnectionString, @"SELECT     dbo.table_004_CommodityAndIngredients.columnid AS GoodId, dbo.table_003_SubsidiaryGroup.column03 as SubName
            FROM         dbo.table_004_CommodityAndIngredients INNER JOIN
            ...
            dbo.table_004_CommodityAndIngredients.column03 = dbo.table_003_SubsidiaryGroup.column01");
        ...
        private void bt_Search_Click(object sender, EventArgs e)
        {
            if (faDatePickerStrip1.FADatePicker.SelectedDateTime.HasValue && faDatePickerStrip2.FADatePicker.SelectedDateTime.HasValue)
            {
                ...
                {
                    this.rpt_SaleFactor_GoodTableAdapter.FillBy_All(dataSet_Sale.Rpt_SaleFactor_Good, Date1, Date2,chk_Currency.Checked);
                    this.rpt_SaleFactor_CustomerTableAdapter.FillBy_All(dataSet_Sale.Rpt_SaleFactor_Customer, Date1, Date2, chk_Currency.Checked);
                    this.rpt_SaleFactor_FactorsTableAdapter.FillBy_All(dataSet_Sale.Rpt_SaleFactor_Factors, Date1, Date2, chk_Currency.Checked);
                }
                else
                {
                    ...
                    {
                        case 1:
                            this.rpt_SaleFactor_GoodTableAdapter.FillBy_Cancel(dataSet_Sale.Rpt_SaleFactor_Good, Date1, Date2, true, chk_Currency.Checked);
                            this.rpt_SaleFactor_CustomerTableAdapter.Fill_Cancel(dataSet_Sale.Rpt_SaleFactor_Customer, Date1, Date2, true, chk_Currency.Checked);
                            this.rpt_SaleFactor_FactorsTableAdapter.Fill_Cancel(dataSet_Sale.Rpt_SaleFactor_Factors, Date1, Date2, true, chk_Currency.Checked);
                            
                            break;
                        case 2:
                            this.rpt_SaleFactor_GoodTableAdapter.FillBy_Cancel(dataSet_Sale.Rpt_SaleFactor_Good, Date1, Date2, false, chk_Currency.Checked);
                            this.rpt_SaleFactor_CustomerTableAdapter.Fill_Cancel(dataSet_Sale.Rpt_SaleFactor_Customer, Date1, Date2, false, chk_Currency.Checked);
                            this.rpt_SaleFactor_FactorsTableAdapter.Fill_Cancel(dataSet_Sale.Rpt_SaleFactor_Factors, Date1, Date2, false, chk_Currency.Checked);
                            break;
                    }
                }
            }
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                gridEX_Goods.RootTable.ColumnSets["ColumnSet2"].Visible = true;
            }
            else
                gridEX_Goods.RootTable.ColumnSets["ColumnSet2"].Visible = false;
        }

        private void chk_Pack_CheckedChanged(object sender, EventArgs e)
        {
            if (chk_Pack.Checked)
            {
                gridEX_Goods.RootTable.ColumnSets["ColumnSet3"].Visible = true;
            }
            else
                gridEX_Goods.RootTable.ColumnSets["ColumnSet3"].Visible = false;
        }
        ...
        private void chk_Detail_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                gridEX_Goods.RootTable.ColumnSets["ColumnSet4"].Visible = true;
            }
            else
                gridEX_Goods.RootTable.ColumnSets["ColumnSet4"].Visible = false;
        }
