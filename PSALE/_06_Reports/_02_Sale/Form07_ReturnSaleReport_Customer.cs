...
{
    public partial class Form07_ReturnSaleReport_Customer : Form
    {
        ...
        public Form07_ReturnSaleReport_Customer()
        {
            InitializeComponent();
        }
        ...
        private void Form02_SaleReport_Customer_Load(object sender, EventArgs e)
        {
            ...
            string[] Dates = Properties.Settings.Default.ReturnSaleReport_Customer.Split('-');
            ...
            gridEX_Customers.DropDowns["Group"].SetDataBinding(PersonGroup, "");
        }
        ...
        private void bt_Search_Click(object sender, EventArgs e)
        {
            if (faDatePickerStrip1.FADatePicker.SelectedDateTime.HasValue && faDatePickerStrip2.FADatePicker.SelectedDateTime.HasValue)
            {
                ...
                Date2 = faDatePickerStrip2.FADatePicker.Text;
                    ...
                    this.rpt_ReturnFactor_CustomerTableAdapter.Fill(dataSet_Sale.Rpt_ReturnFactor_Customer, Date1, Date2);
                    this.rpt_ReturnFactor_Customer_FactorsTableAdapter.Fill(dataSet_Sale.Rpt_ReturnFactor_Customer_Factors, Date1, Date2);
                    this.rpt_ReturnFactor_Customer_Child1TableAdapter.Fill(dataSet_Sale.Rpt_ReturnFactor_Customer_Child1, Date1, Date2);
                    this.rpt_ReturnFactor_Customer_Child2TableAdapter.Fill(dataSet_Sale.Rpt_ReturnFactor_Customer_Child2, Date1, Date2);
            }
        }
        ...
        private void Form02_SaleReport_Customer_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (faDatePickerStrip1.FADatePicker.SelectedDateTime.HasValue && faDatePickerStrip2.FADatePicker.SelectedDateTime.HasValue)
                Properties.Settings.Default.ReturnSaleReport_Customer = faDatePickerStrip1.FADatePicker.Text + "-" + faDatePickerStrip2.FADatePicker.Text;
        ...
        private void mnu_PrintThis_Click(object sender, EventArgs e)
        {
            ...
            if (Table.Rows.Count > 0)
            {
                _06_Reports.Form01_ReportForm frm = new Form01_ReportForm(Table, 24, "از تاریخ: " + Date1, "تا تاریخ: " + Date2);
                frm.ShowDialog();
            }
        }
