...
{
    public partial class Form05_SaleReport_Monthly_Value_Currency : Form
    {
        SqlConnection ConSale = new SqlConnection(Properties.Settings.Default.SALE);
        SqlConnection ConWare = new SqlConnection(Properties.Settings.Default.WHRS);
        public Form05_SaleReport_Monthly_Value_Currency()
        {
            InitializeComponent();
        }
        ...
        private void mnu_PrintTable_Click(object sender, EventArgs e)
        {
            ...
            {
                _06_Reports.Form01_ReportForm frm = new Form01_ReportForm(Table, 14, "***فروش ارزی***", " ");
                frm.ShowDialog();
            }
        }
