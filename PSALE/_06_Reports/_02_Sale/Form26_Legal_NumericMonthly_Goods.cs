...
{
    public partial class Form26_Legal_NumericMonthly_Goods : Form
    {
        SqlConnection ConSale = new SqlConnection(Properties.Settings.Default.SALE);
        SqlConnection ConWare = new SqlConnection(Properties.Settings.Default.WHRS);
        public Form26_Legal_NumericMonthly_Goods()
        {
            InitializeComponent();
        }
        ...
        private void Form04_SaleReport_NumericMonthly_Load(object sender, EventArgs e)
        {
			...
			GoodTable.column01 AS GoodCode, GoodTable.column02 AS GoodName
            FROM         (SELECT     TOP (100) PERCENT SUBSTRING(dbo.Table_055_LegalFactors.column02, 1, 4) AS Year, SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) AS Month, 
            dbo.Table_060_Child1_LegalFactors.column02 AS GoodID, SUM(dbo.Table_060_Child1_LegalFactors.column07) AS TotalNumber, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '01' THEN SUM(dbo.Table_060_Child1_LegalFactors.column07) ELSE 0 END AS Far, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '01' THEN SUM(dbo.Table_060_Child1_LegalFactors.column04) ELSE 0 END AS FarBox, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '01' THEN SUM(dbo.Table_060_Child1_LegalFactors.column05) ELSE 0 END AS FarPack, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '01' THEN SUM(dbo.Table_060_Child1_LegalFactors.column06) ELSE 0 END AS FarDetail, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '02' THEN SUM(dbo.Table_060_Child1_LegalFactors.column07) ELSE 0 END AS Ord, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '02' THEN SUM(dbo.Table_060_Child1_LegalFactors.column04) ELSE 0 END AS OrdBox, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '02' THEN SUM(dbo.Table_060_Child1_LegalFactors.column05) ELSE 0 END AS OrdPack, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '02' THEN SUM(dbo.Table_060_Child1_LegalFactors.column06) ELSE 0 END AS OrdDetail, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '03' THEN SUM(dbo.Table_060_Child1_LegalFactors.column07) ELSE 0 END AS Khord,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '03' THEN SUM(dbo.Table_060_Child1_LegalFactors.column04) ELSE 0 END AS KhordBox,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '03' THEN SUM(dbo.Table_060_Child1_LegalFactors.column05) ELSE 0 END AS KhordPack,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '03' THEN SUM(dbo.Table_060_Child1_LegalFactors.column06) ELSE 0 END AS KhordDetail,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '04' THEN SUM(dbo.Table_060_Child1_LegalFactors.column07) ELSE 0 END AS Tir, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '04' THEN SUM(dbo.Table_060_Child1_LegalFactors.column04) ELSE 0 END AS TirBox, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '04' THEN SUM(dbo.Table_060_Child1_LegalFactors.column05) ELSE 0 END AS TirPack, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '04' THEN SUM(dbo.Table_060_Child1_LegalFactors.column06) ELSE 0 END AS TirDetail, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '05' THEN SUM(dbo.Table_060_Child1_LegalFactors.column07) ELSE 0 END AS Mordad,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '05' THEN SUM(dbo.Table_060_Child1_LegalFactors.column04) ELSE 0 END AS MordadBox,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '05' THEN SUM(dbo.Table_060_Child1_LegalFactors.column05) ELSE 0 END AS MordadPack,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '05' THEN SUM(dbo.Table_060_Child1_LegalFactors.column06) ELSE 0 END AS MordadDetail,
            
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '06' THEN SUM(dbo.Table_060_Child1_LegalFactors.column07) ELSE 0 END AS Shahr,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '06' THEN SUM(dbo.Table_060_Child1_LegalFactors.column04) ELSE 0 END AS ShahrBox,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '06' THEN SUM(dbo.Table_060_Child1_LegalFactors.column05) ELSE 0 END AS ShahrPack,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '06' THEN SUM(dbo.Table_060_Child1_LegalFactors.column06) ELSE 0 END AS ShahrDetail,
            
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '07' THEN SUM(dbo.Table_060_Child1_LegalFactors.column07) ELSE 0 END AS Mehr,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '07' THEN SUM(dbo.Table_060_Child1_LegalFactors.column04) ELSE 0 END AS MehrBox,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '07' THEN SUM(dbo.Table_060_Child1_LegalFactors.column05) ELSE 0 END AS MehrPack,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '07' THEN SUM(dbo.Table_060_Child1_LegalFactors.column06) ELSE 0 END AS MehrDetail,
            
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '08' THEN SUM(dbo.Table_060_Child1_LegalFactors.column07) ELSE 0 END AS Aban,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '08' THEN SUM(dbo.Table_060_Child1_LegalFactors.column04) ELSE 0 END AS AbanBox,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '08' THEN SUM(dbo.Table_060_Child1_LegalFactors.column05) ELSE 0 END AS AbanPack,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '08' THEN SUM(dbo.Table_060_Child1_LegalFactors.column06) ELSE 0 END AS AbanDetail,
            
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '09' THEN SUM(dbo.Table_060_Child1_LegalFactors.column07) ELSE 0 END AS Azar,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '09' THEN SUM(dbo.Table_060_Child1_LegalFactors.column04) ELSE 0 END AS AzarBox,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '09' THEN SUM(dbo.Table_060_Child1_LegalFactors.column05) ELSE 0 END AS AzarPack,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '09' THEN SUM(dbo.Table_060_Child1_LegalFactors.column06) ELSE 0 END AS AzarDetail,
            
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '10' THEN SUM(dbo.Table_060_Child1_LegalFactors.column07) ELSE 0 END AS Dey, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '10' THEN SUM(dbo.Table_060_Child1_LegalFactors.column04) ELSE 0 END AS DeyBox, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '10' THEN SUM(dbo.Table_060_Child1_LegalFactors.column05) ELSE 0 END AS DeyPack, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '10' THEN SUM(dbo.Table_060_Child1_LegalFactors.column06) ELSE 0 END AS DeyDetail, 
            
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '11' THEN SUM(dbo.Table_060_Child1_LegalFactors.column07) ELSE 0 END AS Bahman, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '11' THEN SUM(dbo.Table_060_Child1_LegalFactors.column04) ELSE 0 END AS BahmanBox, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '11' THEN SUM(dbo.Table_060_Child1_LegalFactors.column05) ELSE 0 END AS BahmanPack, 
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '11' THEN SUM(dbo.Table_060_Child1_LegalFactors.column06) ELSE 0 END AS BahmanDetail, 
            
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '12' THEN SUM(dbo.Table_060_Child1_LegalFactors.column07) ELSE 0 END AS Esf,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '12' THEN SUM(dbo.Table_060_Child1_LegalFactors.column04) ELSE 0 END AS EsfBox,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '12' THEN SUM(dbo.Table_060_Child1_LegalFactors.column05) ELSE 0 END AS EsfPack,
            CASE WHEN SUBSTRING(dbo.Table_055_LegalFactors.column02, 6, 2) = '12' THEN SUM(dbo.Table_060_Child1_LegalFactors.column06) ELSE 0 END AS EsfDetail
            FROM          dbo.Table_055_LegalFactors INNER JOIN
            dbo.Table_060_Child1_LegalFactors ON dbo.Table_055_LegalFactors.columnid = dbo.Table_060_Child1_LegalFactors.column01
            GROUP BY SUBSTRING(dbo.Table_055_LegalFactors.column02, 1, 4), dbo.Table_060_Child1_LegalFactors.column02, SUBSTRING(dbo.Table_055_LegalFactors.column02, 
            6, 2)
