...
{
    public partial class Form02_SaleReport_Customer : Form
    {
        ...
        public Form02_SaleReport_Customer()
        {
            InitializeComponent();
        }
        ...
        private void Form02_SaleReport_Customer_Load(object sender, EventArgs e)
        {
            ...
            DataTable CurrencyTbl = clDoc.ReturnTable(ConBase.ConnectionString, "Select * from Table_055_CurrencyInfo");
            gridEX_Factors.DropDowns["Currency"].SetDataBinding(CurrencyTbl, "");
            gridEX_List.DropDowns["Currency"].SetDataBinding(CurrencyTbl, "");
        ...
        private void bt_Search_Click(object sender, EventArgs e)
        {
            if (faDatePickerStrip1.FADatePicker.SelectedDateTime.HasValue && faDatePickerStrip2.FADatePicker.SelectedDateTime.HasValue)
            {
                ...
                {
                    this.table_010_SaleFactor_ReportCustomerTableAdapter.FillBy_All(dataSet_Sale.Table_010_SaleFactor_ReportCustomer, Date1, Date2);
                    this.table_010_SaleFactor_ReportCustomer_Detail1TableAdapter.FillBy_All(dataSet_Sale.Table_010_SaleFactor_ReportCustomer_Detail1, Date1, Date2);
                    this.table_011_Child1_SaleFactor_ReportCustomerTableAdapter.Fill(dataSet_Sale.Table_011_Child1_SaleFactor_ReportCustomer, Date1, Date2);
                    this.table_012_Child2_SaleFactor_ReportCustomerTableAdapter.Fill(dataSet_Sale.Table_012_Child2_SaleFactor_ReportCustomer, Date1, Date2);
                }
                else
                {
                    ...
                    {
                        case 1:
                             this.table_010_SaleFactor_ReportCustomerTableAdapter.Fillby_Cancel(dataSet_Sale.Table_010_SaleFactor_ReportCustomer, Date1, Date2,true);
                    this.table_010_SaleFactor_ReportCustomer_Detail1TableAdapter.FillBy_Cancel(dataSet_Sale.Table_010_SaleFactor_ReportCustomer_Detail1, Date1, Date2,true);
                    this.table_011_Child1_SaleFactor_ReportCustomerTableAdapter.Fill(dataSet_Sale.Table_011_Child1_SaleFactor_ReportCustomer, Date1, Date2);
                    this.table_012_Child2_SaleFactor_ReportCustomerTableAdapter.Fill(dataSet_Sale.Table_012_Child2_SaleFactor_ReportCustomer, Date1, Date2);

                            break;
                        case 2:
                             this.table_010_SaleFactor_ReportCustomerTableAdapter.Fillby_Cancel(dataSet_Sale.Table_010_SaleFactor_ReportCustomer, Date1, Date2,false);
                    this.table_010_SaleFactor_ReportCustomer_Detail1TableAdapter.FillBy_Cancel(dataSet_Sale.Table_010_SaleFactor_ReportCustomer_Detail1, Date1, Date2,false);
                    this.table_011_Child1_SaleFactor_ReportCustomerTableAdapter.Fill(dataSet_Sale.Table_011_Child1_SaleFactor_ReportCustomer, Date1, Date2);
                    this.table_012_Child2_SaleFactor_ReportCustomerTableAdapter.Fill(dataSet_Sale.Table_012_Child2_SaleFactor_ReportCustomer, Date1, Date2);
        ...
        private void mnu_PrintThis_Click(object sender, EventArgs e)
        {
            ...
            if (Table.Rows.Count > 0)
            {
                _06_Reports.Form01_ReportForm frm = new Form01_ReportForm(Table, 10,Date1, Date2);
                frm.ShowDialog();
            }
        }
            ...
            try
            {
                if (this.gridEX_Factors.RowCount > 0)
                {
                    if (UserScope.CheckScope(Class_BasicOperation._UserName, "Column11", 20))
                    {
                        ...
                        _05_Sale.Frm_002_Faktor frms = new _05_Sale.Frm_002_Faktor(UserScope.CheckScope(Class_BasicOperation._UserName, "Column11", 21), Convert.ToInt32(gridEX_Factors.GetValue("ColumnId").ToString()));
                        try
                        {
