...
{
    public partial class Form05_SaleReport_Monthly_Value_Goods_Visitor : Form
    {
    
        public Form05_SaleReport_Monthly_Value_Goods_Visitor()
        {
            InitializeComponent();
        }
        ...
        private void Form04_SaleReport_NumericMonthly_Visitor_Load(object sender, EventArgs e)
        {
            ...
            rpt_Sale_Monthly_Value_Visitor_GoodTableAdapter.Fill(dataSet_Report.Rpt_Sale_Monthly_Value_Visitor_Good, Class_BasicOperation._Year);
        ...
        private void mnu_PrintAll_Click(object sender, EventArgs e)
        {
            ...
            foreach (Janus.Windows.GridEX.GridEXRow Row in gridEX_Visitors.GetCheckedRows())
            {
                ...
                {
                    Table.Rows.Add(item.Cells["GoodCode"].Text.ToString(),
            ...
            {
                _06_Reports.Form01_ReportForm frm = new Form01_ReportForm(Table, 41, Class_BasicOperation._Year," ");
                frm.ShowDialog();
            }
        }
            ...
            try
            {
                try
                {
                    ...
                    if (Table.Rows.Count > 0)
                    {
                        ...
                        Title.Text = "نمودار ماهیانه میزان فروش ریالی   " + e.Row.Cells["GoodName"].Text;
