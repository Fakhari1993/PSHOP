...
{
    public partial class Frm_017_SortReturnBuyFactors : Form
    {
        ...
        public Frm_017_SortReturnBuyFactors()
        {
            InitializeComponent();
        }
        ...
        private void Form_008_ViewSaleFactors_Load(object sender, EventArgs e)
        {
            ...
            //*******************************************
            HeaderAdapter = new SqlDataAdapter("Select * from Table_021_MarjooiBuy ", ConSale);
            ...
            dbo.Table_022_Child1_MarjooiBuy ON dbo.Table_021_MarjooiBuy.columnid = dbo.Table_022_Child1_MarjooiBuy.column01 ", ConSale);
            ...
            dbo.Table_023_Child2_MarjooiBuy ON dbo.Table_021_MarjooiBuy.columnid = dbo.Table_023_Child2_MarjooiBuy.column01 ", ConSale);
        ...
        {
            {
                ...
                HeaderAdapter = new SqlDataAdapter("Select * from Table_021_MarjooiBuy where Column02>='" + faDatePickerStrip1.FADatePicker.Text + "' and Column02<='" + faDatePickerStrip2.FADatePicker.Text + "'", ConSale);
                HeaderAdapter.Fill(dataSet1, "Header");

                Child1Adapter = new SqlDataAdapter(@"SELECT     dbo.Table_022_Child1_MarjooiBuy.*    FROM         dbo.Table_021_MarjooiBuy INNER JOIN
                 dbo.Table_022_Child1_MarjooiBuy ON dbo.Table_021_MarjooiBuy.columnid = dbo.Table_022_Child1_MarjooiBuy.column01 WHERE     (dbo.Table_021_MarjooiBuy.column02 >='" + faDatePickerStrip1.FADatePicker.Text + "' and dbo.Table_021_MarjooiBuy.column02<='" + faDatePickerStrip2.FADatePicker.Text + "')", ConSale);
                Child1Adapter.Fill(dataSet1, "Child1");

                Child2Adapter = new SqlDataAdapter(@"SELECT     dbo.Table_023_Child2_MarjooiBuy.*    FROM         dbo.Table_021_MarjooiBuy INNER JOIN
                dbo.Table_023_Child2_MarjooiBuy ON dbo.Table_021_MarjooiBuy.columnid = dbo.Table_023_Child2_MarjooiBuy.column01 WHERE     (dbo.Table_021_MarjooiBuy.column02 >='" + faDatePickerStrip1.FADatePicker.Text + "' and dbo.Table_021_MarjooiBuy.column02<='" + faDatePickerStrip2.FADatePicker.Text + "')", ConSale);
                Child2Adapter.Fill(dataSet1, "Child2");
        ...
        private void bt_Sort_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConnection Con = new SqlConnection(Properties.Settings.Default.ACNT);
                Con.Open();
                SqlDataAdapter Adapter = new SqlDataAdapter(
                    "select *, row_Number() over (order by column02,ColumnId) as RowNumber from Table_021_MarjooiBuy " +
                ...
                {
                    Update.CommandText = "Update Table_021_MarjooiBuy SET column01=" +
