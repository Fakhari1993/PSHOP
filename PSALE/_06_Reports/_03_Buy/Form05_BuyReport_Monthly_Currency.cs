...
{
    public partial class Form05_BuyReport_Monthly_Currency : Form
    {
        SqlConnection ConSale = new SqlConnection(Properties.Settings.Default.SALE);
        SqlConnection ConWare = new SqlConnection(Properties.Settings.Default.WHRS);
        public Form05_BuyReport_Monthly_Currency()
        {
            InitializeComponent();
        }
        ...
        private void Form04_SaleReport_NumericMonthly_Load(object sender, EventArgs e)
        {
            ...
            dbo.Table_016_Child1_BuyFactor.column02 AS GoodID, SUM(dbo.Table_016_Child1_BuyFactor.Column11) AS TotalNumber, 
            CASE WHEN SUBSTRING(dbo.Table_015_BuyFactor.column02, 6, 2) = '01' THEN SUM(dbo.Table_016_Child1_BuyFactor.Column11) ELSE 0 END AS Far, 
            CASE WHEN SUBSTRING(dbo.Table_015_BuyFactor.column02, 6, 2) = '02' THEN SUM(dbo.Table_016_Child1_BuyFactor.Column11) ELSE 0 END AS Ord, 
            CASE WHEN SUBSTRING(dbo.Table_015_BuyFactor.column02, 6, 2) = '03' THEN SUM(dbo.Table_016_Child1_BuyFactor.Column11) ELSE 0 END AS Khord,
            CASE WHEN SUBSTRING(dbo.Table_015_BuyFactor.column02, 6, 2) = '04' THEN SUM(dbo.Table_016_Child1_BuyFactor.Column11) ELSE 0 END AS Tir, 
            CASE WHEN SUBSTRING(dbo.Table_015_BuyFactor.column02, 6, 2) = '05' THEN SUM(dbo.Table_016_Child1_BuyFactor.Column11) 
            ELSE 0 END AS Mordad, CASE WHEN SUBSTRING(dbo.Table_015_BuyFactor.column02, 6, 2) 
            = '06' THEN SUM(dbo.Table_016_Child1_BuyFactor.Column11) ELSE 0 END AS Shahr, CASE WHEN SUBSTRING(dbo.Table_015_BuyFactor.column02, 6, 
            2) = '07' THEN SUM(dbo.Table_016_Child1_BuyFactor.Column11) ELSE 0 END AS Mehr, CASE WHEN SUBSTRING(dbo.Table_015_BuyFactor.column02, 6, 
            2) = '08' THEN SUM(dbo.Table_016_Child1_BuyFactor.Column11) ELSE 0 END AS Aban, CASE WHEN SUBSTRING(dbo.Table_015_BuyFactor.column02, 6, 
            2) = '09' THEN SUM(dbo.Table_016_Child1_BuyFactor.Column11) ELSE 0 END AS Azar, CASE WHEN SUBSTRING(dbo.Table_015_BuyFactor.column02, 6, 
            2) = '10' THEN SUM(dbo.Table_016_Child1_BuyFactor.Column11) ELSE 0 END AS Dey, CASE WHEN SUBSTRING(dbo.Table_015_BuyFactor.column02, 6, 
            2) = '11' THEN SUM(dbo.Table_016_Child1_BuyFactor.Column11) ELSE 0 END AS Bahman, CASE WHEN SUBSTRING(dbo.Table_015_BuyFactor.column02,
            6, 2) = '12' THEN SUM(dbo.Table_016_Child1_BuyFactor.Column11) ELSE 0 END AS Esf
            ...
            Where Table_015_BuyFactor.Column15=1
        ...
        private void mnu_PrintTable_Click(object sender, EventArgs e)
        {
            ...
            {
                _06_Reports.Form01_ReportForm frm = new Form01_ReportForm(Table, 21);
                frm.ShowDialog();
            }
        }
        ...
        private void gridEX_Accounts_RowDoubleClick(object sender, Janus.Windows.GridEX.RowActionEventArgs e)
        {
            try
            {
                ...
                if (Table.Rows.Count > 0)
                {
                    _06_Reports._03_Buy.Rpt05_Buy_Monthly_Charts rpt = new Rpt05_Buy_Monthly_Charts();
                    rpt.SetDataSource(Table);
                    TextObject Title = (TextObject)rpt.ReportDefinition.ReportObjects["Text3"];
                    Title.Text = "نمودار ماهیانه میزان خرید ریالی کالای  " + e.Row.Cells["GoodName"].Text;
        ...
        private void mnu_PrintBoth_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Table.Rows.Count > 0)
                {
                    _06_Reports.Form01_ReportForm frm = new Form01_ReportForm(Table, 22, gridEX_Goods.GetRow().Cells["GoodCode"].Text, gridEX_Goods.GetRow().Cells["GoodName"].Text);
                    frm.ShowDialog();
                }
            }
            catch { }
