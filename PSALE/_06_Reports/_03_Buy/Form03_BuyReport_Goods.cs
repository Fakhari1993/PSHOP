...
{
    public partial class Form03_BuyReport_Goods : Form
    {
        ...
        private void Form03_SaleReport_Goods_Load(object sender, EventArgs e)
        {
            ...
            string[] Dates = Properties.Settings.Default.BuyReport_Goods.Split('-');
        ...
        private void bt_Search_Click(object sender, EventArgs e)
        {
            if (faDatePickerStrip1.FADatePicker.SelectedDateTime.HasValue && faDatePickerStrip2.FADatePicker.SelectedDateTime.HasValue)
            {
                ...
                {
                    this.rpt_Buy_Good_HeaderTableAdapter.FillBy_All(dataSet_Buy.Rpt_Buy_Good_Header, Date1, Date2, chk_Currency.Checked);
                    this.rpt_Buy_Good_SuppliersTableAdapter.FillBy_All(dataSet_Buy.Rpt_Buy_Good_Suppliers, Date1, Date2, chk_Currency.Checked);
                    this.rpt_Buy_Good_FactorsTableAdapter.FillBy_All(dataSet_Buy.Rpt_Buy_Good_Factors, Date1, Date2, chk_Currency.Checked);
                }
                else
                {
                    ...
                    {
                        case 1:
                            this.rpt_Buy_Good_HeaderTableAdapter.Fill_Cancel(dataSet_Buy.Rpt_Buy_Good_Header, Date1, Date2, true, chk_Currency.Checked);
                            this.rpt_Buy_Good_SuppliersTableAdapter.Fill_Cancel(dataSet_Buy.Rpt_Buy_Good_Suppliers, Date1, Date2, true, chk_Currency.Checked);
                            this.rpt_Buy_Good_FactorsTableAdapter.Fill_Cancel(dataSet_Buy.Rpt_Buy_Good_Factors, Date1, Date2, true, chk_Currency.Checked);

                            break;
                        case 2:
                            this.rpt_Buy_Good_HeaderTableAdapter.Fill_Cancel(dataSet_Buy.Rpt_Buy_Good_Header, Date1, Date2, false, chk_Currency.Checked);
                            this.rpt_Buy_Good_SuppliersTableAdapter.Fill_Cancel(dataSet_Buy.Rpt_Buy_Good_Suppliers, Date1, Date2, false, chk_Currency.Checked);
                            this.rpt_Buy_Good_FactorsTableAdapter.Fill_Cancel(dataSet_Buy.Rpt_Buy_Good_Factors, Date1, Date2, false, chk_Currency.Checked);
                            break;
                    }
                }
            }
        ...
        private void Form03_SaleReport_Goods_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (faDatePickerStrip1.FADatePicker.SelectedDateTime.HasValue && faDatePickerStrip2.FADatePicker.SelectedDateTime.HasValue)
                Properties.Settings.Default.BuyReport_Goods = faDatePickerStrip1.FADatePicker.Text + "-" + faDatePickerStrip2.FADatePicker.Text;
        ...
        private void mnu_PrintThis_Click(object sender, EventArgs e)
        {
            ...
            {
                _06_Reports.Form01_ReportForm frm = new Form01_ReportForm(Table, 18, "از تاریخ: " + Date1, "تا تاریخ: " + Date2);
                frm.ShowDialog();
            }
        }
