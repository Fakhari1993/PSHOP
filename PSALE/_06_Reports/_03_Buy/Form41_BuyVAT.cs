...
{
    public partial class Form41_BuyVAT : Form
    {
        ...
        private void bt_Search_Click(object sender, EventArgs e)
        {
            string command = @"SELECT tpi.Column02 AS [name],
                                ...
                                WHERE    tsf.column02>='" + faDatePickerStrip1.FADatePicker.Text + "' AND tsf.column02<='" + faDatePickerStrip2.FADatePicker.Text + "' AND tsf.column19=0 ";
            ...
            try
            {
                ...
                if (pageSetupDialog1.ShowDialog() == DialogResult.OK)
                    if (printDialog1.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        gridEXPrintDocument1.PageHeaderRight = "گزارش مالیات بر ارزش افزوده خرید";
